...
@media (prefers-color-scheme: light) {
  html.ns-light-ok {
    ...
    --fg1:rgba(9,12,22,.95); --fg2:rgba(9,12,22,.78); --fg3:rgba(9,12,22,.60);
    --fg4:rgba(9,12,22,.52);
    --s1:rgba(12,17,34,.030); --s2:rgba(12,17,34,.055); --s3:rgba(12,17,34,.085);
    --bd1:rgba(12,17,34,.08); --bd2:rgba(12,17,34,.13);
    --accent:#2f66d8; --accent-bg:rgba(47,102,216,.10);
    --ok:#0f8168; --ok-bg:rgba(15,129,104,.12);
    --warn:#96650f; --warn-bg:rgba(150,101,15,.13);
    --danger:#a5388b; --danger-bg:rgba(165,56,139,.12);
    --accent-hover:#1a4bb0;
  }
}
