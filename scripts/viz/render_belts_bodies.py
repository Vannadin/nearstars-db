...
BODIES={
 ...
 'jupiter_phys':{'title':'Jupiter — physical (torus fit)','sub':'D-cut dipolar inner (peak ~2 R_J) + flat magnetodisc outer','R':18,'tilt':10.3,'offset':0.1,
   'inner':{'radiation':1500,'grad':3.3,'dist':2.0,'rad':2.0,'dxy':0.7,'comp':1.05,'ext':0.9,'bdist':1e-4,'brad':1.3},
   'outer':{'radiation':150,'grad':2.2,'dist':4.17,'rad':2.5,'dxy':0.174,'comp':1.05,'ext':0.9},  # 자기원반=적도 전류시트(납작)
 ...
 'saturn_phys':{'title':'Saturn — physical (torus fit)','sub':'rings absorb inner belt; weak CRAND outer crescent; ~0° tilt','R':12,'tilt':0.01,
   'outer':{'radiation':10,'grad':2.2,'dist':4.0,'rad':2.2,'dxy':0.6,'comp':1.05,'ext':0.85,'bdist':1e-4,'brad':2.3},  # 고리 바깥 단일 초승달(D컷)
 ...
 'uranus_phys':{'title':'Uranus — physical (torus fit)','sub':'tilt 59°, offset 0.3 R_U, mp 18, belt peak ~4.2 R_U','R':10,'tilt':59,'offset':0.3,
   'inner':{'radiation':40,'grad':3.3,'dist':1.8,'rad':1.0,'dxy':0.6,'comp':1.02,'ext':1.0,'bdist':1e-4,'brad':1.2},
   'outer':{'radiation':8,'grad':2.2,'dist':4.5,'rad':2.5,'dxy':0.7,'comp':1.02,'ext':0.95,'bdist':1e-4,'brad':3.0},
 ...
 'neptune_phys':{'title':'Neptune — physical (torus fit)','sub':'tilt 47°, offset 0.55 R_N, peak L~7, Triton cut ~14','R':16,'tilt':47,'offset':0.55,
   'inner':{'radiation':30,'grad':3.3,'dist':2.5,'rad':1.3,'dxy':0.6,'comp':1.02,'ext':1.0,'bdist':1e-4,'brad':1.3},
   'outer':{'radiation':6,'grad':2.2,'dist':9.0,'rad':5.0,'dxy':0.7,'comp':1.02,'ext':0.95,'bdist':1e-4,'brad':4.0},  # peak ~L7, 외곽 ~14(Triton)
 ...
 'earth_phys':{'title':'Earth — physical (torus fit)','sub':'inner peak L~1.5, slot L2-3, outer heart L~4.5, standoff 10','R':8,'tilt':11,
   'inner':{'radiation':10.376,'grad':3.3,'dist':1.4,'rad':0.6,'dxy':0.572,'comp':1.01,'ext':1.0,'bdist':1e-4,'brad':1.05},
   'outer':{'radiation':2.214,'grad':2.2,'dist':4.5,'rad':2.5,'dxy':0.72,'comp':1.01,'ext':1.0,'bdist':1e-4,'brad':3.0},  # heart L4.5, D컷서 슬롯(2-3)
 ...
 'ganymede_phys':{'title':'Ganymede — physical (torus fit)','sub':'719 nT dipole, standoff ~2 R_G, single weak belt, open caps','R':4,'tilt':4,
   'inner':{'radiation':0.33,'grad':3.3,'dist':1.3,'rad':0.4,'dxy':0.7,'comp':1.05,'ext':0.9,'bdist':1e-4,'brad':1.05},
