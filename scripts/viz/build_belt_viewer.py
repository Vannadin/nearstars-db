...
SHUE_GROUNDED = {
    ...
    # 금성·화성은 유도 경계다. α 는 적합값이 아니라 '측정된 노즈→명암경계선 벌어짐'의 재매개화이며,
    # 그래서 근거 목록에 넣되 출처 문구로 성격을 밝힌다.
    'venus': (0.113, 1.0545, 11.0, 'Brace 1980 이오노포즈(직하 330 km / 명암경계선) + Saunders 1986 꼬리 — 유도 경계의 Shue 매개화'),
    'mars': (0.188, 1.29, 8.82, 'Vignes 2000 MPB 원뿔 적합 Table 2 (R_SD 1.29 / R_TD 1.47, 꼬리는 e=0.90·L=0.96 에서) — 유도 경계의 Shue 매개화'),
