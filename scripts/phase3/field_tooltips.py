...
FIELD_TOOLTIPS: dict[str, dict[str, str]] = {
    ...
    'radiogenic_heat_w_m2': {
        ...
        'ko': '방사성 동위원소 붕괴 열 (W/m²). 지구: 방사성 ≈ 22 TW (≈ 0.043 W/m²) 대 표면 총 열류 42–47 TW (≈ 0.087) — Nimmo & Primack 2020 이 Sclater+ 1980·Davies 2010 을 인용한 값. 지구뉴트리노는 25.5–51.8 TW (Agostini 2019) 로 아직 다투는 쪽.',
        'en': 'Radiogenic heat from isotope decay (W/m²). Earth: radiogenic ≈ 22 TW (≈ 0.043 W/m²) against a total surface heat flow of 42–47 TW (≈ 0.087), per Nimmo & Primack 2020 citing Sclater+ 1980 and Davies 2010; geoneutrinos give 25.5–51.8 TW (Agostini 2019), the contested side.',
    },
