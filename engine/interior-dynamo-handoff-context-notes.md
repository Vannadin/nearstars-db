...
before the run, after the parallel seat read the methodology's printed **Needs**, `rocky-planet-dynamo-methodology.md@«**Needs** — `mass_earth` [M_earth] · `radius_earth` [R_earth] · `conductor_phase` [—] ·»`):
