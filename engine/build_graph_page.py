...
LABELS = {
    ...
    "interior_layers": "내부 층 기하", "core_state": "핵 상태", "tidal_response": "조석 응답", "xuv_history": "XUV 이력",
    "internal_heat_nontidal": "내부 열",
    "cmb_heat_flux": "핵–맨틀 경계 열유속", "core_energy_balance": "핵 에너지 수지",
    "core_entropy_production": "핵 엔트로피 생성", "core_thermal_history": "핵 열 이력",
...
LAYER = {
    ...
    2: ["interior_layers", "core_state", "tidal_response", "nmoi_class_table", "k2q_class_table",
        "omega0_class_table", "t_exo_bracket", "xuv_history",
        "internal_heat_nontidal", "stellar_wind",
        "cmb_heat_flux", "core_energy_balance", "core_entropy_production",
        "core_thermal_history"],
