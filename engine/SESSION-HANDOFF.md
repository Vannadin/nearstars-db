...
*Written by the parallel seat for the work seat to fold into `engine/SESSION-HANDOFF.md`. The previous block («written 2026-09-11 ~23:30») becomes «superseded by the block above». ⚠ Two placeholders must be filled at fold time: **194's sha** and the remote tip as it stands then. Measurements are attributed in the drafts they came from — the 190 B timings and the 195 proofs are the work seat's, the `@34/@43` and `15 / 35` figures are tool output reproduced by the audit, the closure count is the parallel seat's.*
