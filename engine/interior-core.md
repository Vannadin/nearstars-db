...
1. ⚠ **An inversion that fits one axis will miss the other by more.** Already measured in C59 (a): at
   cmf 0.24 the radius is 8.88 % off and `nmoi` 2.71 %; at 0.325 they are 2.65 % and 5.32 %. The axes move
