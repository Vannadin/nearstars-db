...
| `surface_gravity_g_earth` | ~58 | medium | derived: g = G M / R² with M = 2.26 M_Jup, R = 1.1 R_Jup → ~570 m/s² ≈ 58 g⊕; a high-gravity massive jovian |
...
| `atmosphere_scale_height_km` | ~9 | medium | derived: H = kT / (μ m_H g) with T ≈ 130 K, μ = 2.3, g ≈ 570 m/s² ≈ 9 km; small because of the high surface gravity |
...
| `magnetic_field_microtesla_equator` | 900 | medium | scaled jovian dynamo: Jupiter's surface field ≈ 430 μT; a 2.3 M_Jup planet with vigorous convection and fast rotation scales to a stronger field — cfg picks ~900 μT (~2× Jupiter) reflecting the higher mass and internal heat |
