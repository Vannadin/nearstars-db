...
Bourgeois 2024 ([2008.09599](https://arxiv.org/abs/2008.09599)) magma-ocean evolution gives a water mass
...
| `atmosphere_surface_pressure_pa` | 5 000 | medium | 0.05 bar — below Turbet 2018 ([1707.06927](https://arxiv.org/abs/1707.06927)) stable equilibrium of 150 mbar for pure CO₂ at 174 K; non-equilibrium escape-balanced state assuming ongoing volcanic outgassing. At ≥150 mbar the atmosphere becomes self-sustaining; at <0.01 bar the planet is essentially airless. |
...
| `xuv_flux_at_planet_F_earth` | ~120 (current) | high | Berardo 2025 ([2506.12140](https://arxiv.org/abs/2506.12140)) — revised L_XUV = 1.83×10²⁸ erg/s, 30× higher than 2017 estimates |
...
| `magnetic_field_strength_microtesla_equator` | 10 | low | RM22 ([2203.01065](https://arxiv.org/abs/2203.01065)) scaling; 1.32 M⊕ (largest in system) supports active dynamo |
| `magnetic_dipole_moment_normalized_earth` | 0.35 | medium | RM22 + [2208.06523](https://arxiv.org/abs/2208.06523) (Earth-class core extends dynamo lifetime) — interior hydrosphere convection may also contribute |
...
| `surface_radiation_dose_msv_yr` | 5000 | low | Atri 2019 ([1910.09871](https://arxiv.org/abs/1910.09871)) Table 6 for g at 0.045 AU + 50 g/cm² shielding + B-field. NOTE Atri Table 6 is a dimensionless enhancement-over-GCR factor (and Gray-per-event), NOT an annual mSv/yr dose; the yearly value here is a conversion, so confidence is low |
...
fraction. Bourgeois 2024 ([2008.09599](https://arxiv.org/abs/2008.09599)) finds wmf 0.11–0.24 for g —
...
([2101.08172](https://arxiv.org/abs/2101.08172)) finds that at WMF ≥ 0.14, high-pressure ice phases
...
analysis (Moran 2018, [1810.05210](https://arxiv.org/abs/1810.05210)) excludes cloud-free hydrogen-rich
...
**Caveat — atmosphere retention.** Van Looveren 2024 ([2401.16490](https://arxiv.org/abs/2401.16490))
finds that at g's ~120 F_EUV,⊕ (revised upward from earlier estimates
by Berardo 2025 / [2506.12140](https://arxiv.org/abs/2506.12140), who measured L_XUV = 1.83×10²⁸ erg/s,
...
**Turbet equilibrium reference.** Turbet 2018 ([1707.06927](https://arxiv.org/abs/1707.06927)) explicitly
...
**GCM cross-check.** Fauchez 2019 ([1911.08596](https://arxiv.org/abs/1911.08596)) confirms the snowball
...
**Planet-planet tides.** Hay & Matsuyama 2019 ([1903.04501](https://arxiv.org/abs/1903.04501)) identifies
...
([2203.01065](https://arxiv.org/abs/2203.01065)) scaling places g at ~0.35 × Earth dipole moment despite
...
- **Star in sky.** TRAPPIST-1 subtends 1.36° in g's sky (2.7× the
  ...
  ([1811.04877](https://arxiv.org/abs/1811.04877)) finds a 3-temperature spot model best fits TRAPPIST-1:
...
- **[2412.10192](https://arxiv.org/abs/2412.10192)** Cherubim 2024 — From CO₂- to H₂O-dominated
...
- **[2504.19872](https://arxiv.org/abs/2504.19872)** Castan-Lopez 2025 — Cosmic Shoreline Revisited.
  ...
  thick one.
- **[1810.05210](https://arxiv.org/abs/1810.05210)** Moran 2018 — HST haze limits. Rejects cloud-free
  H₂-rich for inner 5 planets (including g indirectly). Already
  read for d Phase 3.
- **[1706.02689](https://arxiv.org/abs/1706.02689)** Unterborn 2018 — Inward-migration interpretation of
...
- **[1903.04501](https://arxiv.org/abs/1903.04501)** Hay & Matsuyama 2019 — Tides between TRAPPIST-1
...
- **[2401.16490](https://arxiv.org/abs/2401.16490)** Van Looveren 2024 — Airy worlds or barren rocks?
  ...
  cfg variants.
- **[2506.12140](https://arxiv.org/abs/2506.12140)** Berardo 2025 — HST multi-year Ly-α monitoring of
...
- **[1912.05749](https://arxiv.org/abs/1912.05749)** Hori & Ogihara 2020 — Hydrogen-rich atmosphere
...
- **[1707.06927](https://arxiv.org/abs/1707.06927)** Turbet 2018 — Climate diversity modeling for
...
- **[2101.08172](https://arxiv.org/abs/2101.08172)** Acuña 2021 — Hydrosphere characterization. Validates
...
- **[1911.08596](https://arxiv.org/abs/1911.08596)** Fauchez 2019 — Clouds and hazes modeling. Confirms
  g's snowball state even at 10 bar CO₂; only minimal substellar
  cloud formation.
- **[1811.04877](https://arxiv.org/abs/1811.04877)** Wakeford 2019 — HST transmission of g + 3-temperature
...
- **[2203.01065](https://arxiv.org/abs/2203.01065)** RM22 — Rocky-planet dynamo scaling for tidally-locked.
- **[1910.09871](https://arxiv.org/abs/1910.09871)** Atri 2019 — Surface-dose tables for g.

### Read (context / methodology, not decision-driving)

- **[2508.12865](https://arxiv.org/abs/2508.12865)** Empirical determination of the Cosmic Shoreline.
  Context for g's retention status.
- **[2504.01182](https://arxiv.org/abs/2504.01182)** Receding Cosmic Shoreline for mid-to-late M dwarfs.
  TRAPPIST-1 system-level context.
- **[2210.02484](https://arxiv.org/abs/2210.02484)** HZ catalog. Lists g as one of the wider-HZ candidates.
  Already read for d.
- **[2006.11349](https://arxiv.org/abs/2006.11349)** Wunderlich 2020 — Wet/dry e and f. g context only.
  Already read for f.
- **[2506.16063](https://arxiv.org/abs/2506.16063)** Mass-radius plane classification. Catalog context only.
...
- **[2509.06310](https://arxiv.org/abs/2509.06310)** Deep SETI search with FAST. Not visual.
- **[2208.02511](https://arxiv.org/abs/2208.02511)** SETI drift rate context. Not visual.
...
- JWST GO 2589 observed g for flare characterization (per Burdanov
  2025 / [2512.04265](https://arxiv.org/abs/2512.04265)) but no atmosphere retrieval has been published.
...
- [trappist-1-f](trappist-1-f.md) — inner sibling, sits at the snowball/eyeball tipping point; g is unambiguously snowball
- [trappist-1-h](trappist-1-h.md) — outermost sibling; both ice-dominated, different mass / heating budgets
- [trappist-1-e](trappist-1-e.md) — habitable-zone reference contrast
- [methodology](../reference/methodology.md) — Decisions schema
- [mod-reference](../reference/mod-reference.md) — downstream mods
- [rex-data-comparison](../reference/rex-data-comparison.md) — §10 quantifies post-Agol mass/radius for g
