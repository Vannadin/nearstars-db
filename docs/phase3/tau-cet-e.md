...
- **Weir A. — Space.com, "Sci-fi author Andy Weir explains the astrobiology behind Project Hail Mary"**. Provides comparative Erid parameters (29 atm, ammonia, 2.1 g, 6-h day) that frame Adrian as the lower-gravity, CO₂-dominated counterpart in the novel's three-world astrobiology. Important: ammonia + 2.1 g + 6-h day are **Erid's** parameters, not Adrian's — the two worlds are often conflated.
