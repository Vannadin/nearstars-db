...
| `magnetic_field_strength_microtesla_equator` | 1000 | low | Tie-break: a 7.6 M_Jup giant with vigorous interior convection and rapid rotation scales to a strong dynamo — roughly 2× Jupiter's ~430 µT by mass/convection scaling; aesthetic, no measurement |
