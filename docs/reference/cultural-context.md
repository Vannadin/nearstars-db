...
- **Adrian ≠ Erid (worldbuilding-conflation warning)**: Adrian (Tau Cet e) is 1.4 g + CO₂-dominated; Erid (40 Eri A b) is 2.1 g + ammonia + 6-h day. Popular summaries (including some search-engine answer boxes) routinely conflate the two worlds. Anchor parameters above are Adrian-specific.
