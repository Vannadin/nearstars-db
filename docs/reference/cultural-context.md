...
- **Status in real world**: 40 Eri A b confirmed exoplanet (Ma 2018, `2018AJ....155..117M`); 42.245 d period (Weir-cited), 8.47 M⊕ super-Earth, a ≈ 0.224 AU, e = 0.04. Not in the habitable zone in modern terms — the Vulcan fiction predates this discovery and assumed an Earth-like world.
...
- **NS DB**: `40_eridani_a.json` (host A; planet b not yet ingested) + `40_eridani_b.json` (white dwarf, separate star) + `40_eridani_c.json` (M dwarf) — multi-star system. 40 Eri A b ingest + Phase 3 deferred (user 2026-05-27).
