...
Christensen 2010 (A&A 522, A13, [`2010A&A...522A..13R`](https://ui.adsabs.harvard.edu/abs/2010A%26A...522A..13R), arXiv **[1007.1514](https://arxiv.org/abs/1007.1514)**, cached)
...
| GJ 896 A b | 2.26 | 1.10 | 0.50 (range 0.1–0.95) | **1980 µT** (1600–3400) | ~117 000 | low |
| ε Ind A b | 7.6 | 1.12 | 3.5 | **3220 µT** (2600–3700) | ~201 000 | low–med |

> Generated by `engine/dynamo_table.py`, not hand-keyed. Re-run it after any
> change to the anchors above; it fails loudly when a cell drifts from what the
> recipe returns. The ε Ind A b dipole cell previously read `~3700 / 2600 → med`
> — the µT range had leaked into the moment column, understating the moment by
> 54×. GJ 896 A b's age now names the **0.50 Gyr** the central value is computed
> at; the bare range left two readers free to pick the linear or the logarithmic
> midpoint and differ by 17 %.
...
- **Reiners & Christensen 2010**, A&A 522, A13 ([`2010A&A...522A..13R`](https://ui.adsabs.harvard.edu/abs/2010A%26A...522A..13R), arXiv
...
- **Yadav & Thorngren 2017**, ApJL 849, L12 ([`2017ApJ...849L..12Y`](https://ui.adsabs.harvard.edu/abs/2017ApJ...849L..12Y), arXiv
