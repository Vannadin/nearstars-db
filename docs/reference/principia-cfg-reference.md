...
- [principia-geopotential-data](principia-geopotential-data.md) — the **real geopotential values** Principia ships for each Solar System body (Sun, giants, Earth/Mars/Moon), verbatim, with the proto↔cfg mapping + how to write a gas giant like Alpha Centauri A b (Polyphemus)
