...
Santos-Costa 2001 `2001P&SS...49..303S`) → round, not flat. Outer belt is a **hinged
...
`2007JGRA..112.6214R`). Source is passive CRAND, so intensity is orders below Jupiter
(Kollmann 2017). A thin isolated proton belt exists between atmosphere and D-ring
(Roussos 2018 `2018Sci...362.1962R`) — real but negligible for gameplay. Dipole is
...
`1986Sci...233...93S`); the near-sunward spin axis winds the tail into a helix (pitch
5.5°; Behannon 1987 `1987JGR....9215354B`). Polarity sign not stated in the primary
...
(Paranicas 1991 `1991JGR....9619131P`), hard outer cut at Triton's orbit. Field is
...
field lines (Gershman 2015 `2015JGRA..120.8559G`). Stock pause 1.6 is slightly generous
