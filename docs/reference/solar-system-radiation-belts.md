...
| inner belt | 0.813/0.70 dxy 0.572, border 0.915 → equator **1.29–2.0 R_E** | peak **L≈1.5**, ~1.1–2 R_E, lower edge ~1000 km (loss-cone-depleted below; SAA dips to ~200 km via the dipole offset) ✓. The outer bound is a **modelling trade, not the belt's edge**: energetic protons reach L < 3 (Claudepierre 2019), but one shell carries one intensity, so widening the target moves the modelled dose peak off the observed L 1.5 maximum | Selesnick 2016 [`2016JGRA..121.1969S`](https://ui.adsabs.harvard.edu/abs/2016JGRA..121.1969S) (CRAND max L 1.5, solar-proton component L 2); Claudepierre 2019 [`2019JGRA..124..934C`](https://ui.adsabs.harvard.edu/abs/2019JGRA..124..934C); Fennell 2015 [`2015GeoRL..42.1283F`](https://ui.adsabs.harvard.edu/abs/2015GeoRL..42.1283F) (no MeV electrons in the inner zone, so the dose is proton-borne) |
