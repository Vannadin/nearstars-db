...
## Source decisions
- **Mass (binary_orbit):** primary = Lazorenko & Sahlmann 2018 (arXiv 1808.07835,
  cache-verified). Reason: longer astrometric baseline (incl. 1984 ESO-R plate),
  and verifiable against the frozen cache — Bedin 2024 (2403.08865) is more recent
  but its ar5iv extract is EMPTY (Astron. Nachr., not cacheable). Garcia 2017
  (1708.02714) third. Per-component M☉ via /1047.57 (IAU nominal M_Jup).
...
- **Radius:** Phase 1 left null (no measured radius exists). Phase 2 adds the
  ...
  (Vrba 2004 prescription, line 137 of 1406.1518.md). Labeled evolutionary_model
...
- **Teff + luminosity:** Faherty 2014 Table (1406.1518.md:193). log L/L☉ = -4.67±0.04
