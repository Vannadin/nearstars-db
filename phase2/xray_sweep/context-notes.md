...
- **αCen A 26.78** — [1612.06570](https://arxiv.org/abs/1612.06570).md: "detected in the first XMM observation
  in 2003 with L X ≈ 6 × 10 26"; band line "0.2 – 2.0 keV range"; cycle
  "about 15 – 20 years", contrast "nearly one order".
- **αCen B 27.04 (rec)** — [1009.1652](https://arxiv.org/abs/1009.1652).md: "Twenty-seven ROSAT pointings …
  averaging L X = 1.1 ( ± 0.26) × 10 27". Alt 27.60 — [1612.06570](https://arxiv.org/abs/1612.06570).md:
  "spectral modelling of the 2012 XMM data … L X ≈ 4 × 10 27 …
  brightest"; "P act ≈ 8 − 9 yr"; amplitude "about 6 – 9".
- **Proxima R_X −4.4 (rec)** — [1610.03447](https://arxiv.org/abs/1610.03447).md line 197 Table 3 row
  `| Prox Cen | M5.5V | 0.12 | -4.4 | 1.5 | 7.1 | 83 | 90 |` + line 187.
  Alt 27.22 — NEXXUS VizieR J/A+A/417/651 Gl 551 rows: S 27.22 / P 26.81
  / F 27.74 (2026-06-11 query); matches the 27.2 quoted in [0808.2986](https://arxiv.org/abs/0808.2986).md.
- **Barnard 25.3 / −5.8 (rec)** — PRIMARY-VERIFIED after fetching France
  2020 (arXiv [2009.01259](https://arxiv.org/abs/2009.01259), pinned in _bib/stellar-wind.yaml):
  [2009.01259](https://arxiv.org/abs/2009.01259).md line 49 "F X ≈ 4.8 × 10 -14 erg cm -2 s -1 ; log10(L X) =
  ...
  25.85 — Wood 2021 [2105.00019](https://arxiv.org/abs/2105.00019).md Table 3 line 173 + NEXXUS VizieR Gl 699
  (S 25.85 / P 25.74). Alt 25.53±0.54 — [2310.04302](https://arxiv.org/abs/2310.04302).md line 310.
- **tau Cet 26.69** — Wood 2021 [2105.00019](https://arxiv.org/abs/2105.00019).md Table 3 line 194 +
...
- **40 Eri A 27.52 (rec)** — NEXXUS VizieR Gl 166A rows: S 27.52 /
  H 27.17. **Boyajian 2012 divergence**: [1208.2431](https://arxiv.org/abs/1208.2431).html Table 6 GJ 166A
...
- **eps Ind A 27.39 (rec)** — Wood 2005 astro-ph_0506401.html table row
  ...
  measurements (see Paper 2)". Alt R_X −5.62 — [2205.08077](https://arxiv.org/abs/2205.08077).md line 27
