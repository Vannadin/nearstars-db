...
**Volume:** Principia gravity = `mean_radius` (volume) + `reference_radius` (equatorial, J₂-scale)
— no inflation (Jupiter 69911/71492 km precedent). VertexHeightOblateAdvanced visual: c=1 ratios
are all ≥1 → set the **Kopernicus PQS `radius` = polar radius** (= mean × c_physical), else the
body inflates by a·b·c (Dante ×1.22). (Two different fields — Principia ref=equatorial, visual base=polar.)
