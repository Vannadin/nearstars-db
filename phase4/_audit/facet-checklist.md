...
- **Proxima d** (hot airless Mercury-analog, Faria 2022 candidate) — ✅ 11/11. Highlights: e~0.05 synthetic; airless (below shoreline); Teq~317K/substellar~450K; **SPI-inferred B ~16G (Zapatero Osorio 2026, [arXiv:2605.22925](https://arxiv.org/abs/2605.22925)) — first terrestrial-exoplanet field estimate, phase-locked flares**; field cascade → reduced space-weathering + dark flare-weathered magnetic polar caps; biome hybrid 7 (RSS-Mercury geology + 1:1 thermal).
