...
|---|---|---|---|---|
| **Proxima b** | Venus-analog runaway greenhouse (~90 bar CO₂ + SO₂, 표면 안 보임, T_sf ~700 K, 황산 cloud deck) | Lee 2021 ([2109.06963](https://arxiv.org/abs/2109.06963)) Venus-like 대기에서 photochemical escape. Meadows 2018 §3 환경 상태 enumeration | **documented-divergence** | canonical Boutle/Del Genio 의 aquaplanet 으로부터 의도적으로 벗어남. ★ 추천 — 정책 도구의 첫 실전 use-case + 아트 차별화 동시 |
