...
>
> 저는 천문학자도 개발자도 아닙니다. 그저 영화를 전공했고 SF를 좋아한 한 명의 게이머일 뿐입니다. 저는 AI를 사용해 제작한 이 "slop"들을 직접 개발했다고 생각하지 않으며, 다만 실력 좋은 개발자를 옆에 두고 불완전한 지식으로나마 별들로 향하는 길을 기획하는 프로듀서일 뿐이라고 여기고 있습니다.
>
