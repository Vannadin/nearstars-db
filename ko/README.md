...
> 인류는 고대로부터 지금까지 하늘을 우러러 보아왔습니다. 닿을 수 없는 곳의 빛을 붙들어 숫자로, 표로, 논문으로 기록해온 수많은 선구자들이 있었습니다. 이 프로젝트는 그분들께서 평생을 다해 쌓아올린 관측과 계산을 바탕으로 하고 있습니다. 저는 저 깊은 하늘 너머를 탐구한 수많은 연구자들을 존경합니다. 이 위대한 거인들의 어깨에 올라설 수 있음에 감사드리며, 사용한 모든 자료는 출처를 명시하였습니다.
>
