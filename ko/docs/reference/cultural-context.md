...
- **Adrian ≠ Erid (worldbuilding 혼동 경고)**: Adrian (Tau Cet e) 는 1.4 g + CO₂ 우세. Erid (40 Eri A b) 는 2.1 g + ammonia + 6h day. Popular summary (일부 검색 엔진 answer box 포함) 가 두 세계를 자주 혼동. 위의 anchor 파라미터는 Adrian 전용.
