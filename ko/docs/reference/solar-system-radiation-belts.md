...
| inner belt | 0.813/0.70 dxy 0.572, border 0.915 → 적도 **1.29–2.0 R_E** | 피크 **L≈1.5**, ~1.1–2 R_E ✓ | (AP9; Ripoll 2016) |
...
L-shell을 재적합합니다(내대 L 1.1–2, 외대 L 3–7. IoU 0.98/0.98). 스톡 대비 눈에 보이는
차이는 작습니다 — 외대 가장자리 7 vs 6 R_E, 그리고 살짝 더 두꺼운 내대 초승달입니다.
...
| outer belt | 6.5/6.5 (동심 덩어리) | **magnetodisc 판 3–16 R_J × ±2.5** (적합 IoU .87 — 토러스 천장) | Khurana 1989 [`1989JGR....9411791K`](https://ui.adsabs.harvard.edu/abs/1989JGR....9411791K) |
...
| belts | 범용 outer 7/7 덩어리 (0–14 R_U); **radiation_inner 75는 죽은 cfg** (`has_inner = false`) | 두 셸 **L 1.5–3 / L 3–7** (적합 IoU .97/.98), 場 피크 413 nT at 4.19 R_U | Ness 1986 |
...
| inner belt | 0.8/0.6, rad 0.33 | 단일 약한 닫힌-자기력선 벨트 **L 1.1–1.9** (적합 IoU .96), 공급원 기아 | Allioux 2013 [`2013AdSpR..51.1204A`](https://ui.adsabs.harvard.edu/abs/2013AdSpR..51.1204A) |
