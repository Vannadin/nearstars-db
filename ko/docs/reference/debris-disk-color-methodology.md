...
- **Bohren, C. F. & Huffman, D. R. (1983)**: *Absorption and Scattering of Light by
  Small Particles*, Wiley. **Book, no arXiv** (bibcode [`1983asls.book.....B`](https://ui.adsabs.harvard.edu/abs/1983asls.book.....B)). The
...
- **Dohnanyi, J. S. (1969)**: *JGR* 74, 2531. **No arXiv** (bibcode
  [`1969JGR....74.2531D`](https://ui.adsabs.harvard.edu/abs/1969JGR....74.2531D)). *Collisional Model of Asteroids and Their Debris*: the
...
- **Rouleau, F. & Martin, P. G. (1991)**: *ApJ* 377, 526. **No arXiv** (bibcode
  [`1991ApJ...377..526R`](https://ui.adsabs.harvard.edu/abs/1991ApJ...377..526R)). *Shape and Clustering Effects on the Optical Properties of
...
- **Warren, S. G. & Brandt, R. E. (2008)**: *J. Geophys. Res. Atmos.* 113, D14220.
  **No arXiv** (bibcode [`2008JGRD..11314220W`](https://ui.adsabs.harvard.edu/abs/2008JGRD..11314220W)). *Optical constants of ice from the
  ultraviolet to the microwave: a revised compilation*, the water-ice constants
  (`ice`); the revised successor to Warren 1984 ([`1984ApOpt..23.1206W`](https://ui.adsabs.harvard.edu/abs/1984ApOpt..23.1206W)). The tool uses
  the 2008 revision, as cited. §3. (820 cites.)

- **Jäger, C., Dorschner, J., Mutschke, H., Posch, Th. & Henning, Th. (2003)**:
  *A&A* 408, 193. **No arXiv** (bibcode [`2003A&A...408..193J`](https://ui.adsabs.harvard.edu/abs/2003A%26A...408..193J)). *Steps toward
...
- **Khare, B. N., Sagan, C., Arakawa, E. T., Suits, F., Callcott, T. A. & Williams,
  M. W. (1984)**: *Icarus* 60, 127. **No arXiv** (bibcode [`1984Icar...60..127K`](https://ui.adsabs.harvard.edu/abs/1984Icar...60..127K)).
...
- **Krist, J. E. et al. (2005)**: *AJ* 129, 1008. **No arXiv** (bibcode
  [`2005AJ....129.1008K`](https://ui.adsabs.harvard.edu/abs/2005AJ....129.1008K)). *HST ACS Coronagraphic Imaging of the AU Microscopii Debris
...
- **Polyanskiy, M. N. (2024)**: *Scientific Data* 11, 94. **No arXiv** (bibcode
  [`2024NatSD..11...94P`](https://ui.adsabs.harvard.edu/abs/2024NatSD..11...94P)). The **refractiveindex.info** database; **here the solid/ice-
...
- [atmosphere-reflected-color-methodology](atmosphere-reflected-color-methodology.md): 여기서 재사용하는
  ...
  **refractiveindex.info 포털**(Polyanskiy 2024; 거기서는 기체상, 여기서는 고체·얼음상)
  ...
  혼동하지 말라.
- [surface-color-albedo-methodology](surface-color-albedo-methodology.md): 고체 표면용 **자매 문서**. 그
...
- [planetary-dynamo-scaling](planetary-dynamo-scaling.md): 인용 엄밀성과 유효 영역 정직성(arXiv
