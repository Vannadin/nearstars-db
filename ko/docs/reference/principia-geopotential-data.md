...
가상의 거대행성에는 측정된 J₂가 없으므로, 파생값 규칙에 따라 우리가 근거로 삼는 것은 가짜 측정값이 아니라 **방법**입니다. 1차 **Radau–Darwin 관계**를 사용합니다(Helled, Anderson, Schubert & Stevenson 2011, eq. 3, arXiv:1109.1627; 원전 Zharkov & Trubitsyn 1978 / Murray & Dermott 1999 §4.4).
...
자유 입력값은 단 하나, **정규화된 관성 모멘트** NMoI = C/MR²(중심 집중도)입니다. 이 값은 측정된 거대행성들로 범위를 정합니다 — 목성 ≈ 0.264, 토성 ≈ 0.21, 얼음 거대행성 ≈ 0.22–0.24 (Helled+2011/2020 [arXiv:2007.10783]; Fortney+2018 [arXiv:1609.06324]; 균질 구체 = 0.40). 질량이 더 작고 밀도가 더 낮은 거대행성은 토성보다 중심 집중이 *덜* 되어 NMoI가 약간 더 높습니다.
