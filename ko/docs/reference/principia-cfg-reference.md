...
- [principia-geopotential-data](principia-geopotential-data.md) — Principia 가 천체별로 싣고 있는 **실제 지오포텐셜 값**(태양·거대행성·지구/화성/달)을 verbatim 으로, proto↔cfg 매핑 + Alpha Centauri A b (Polyphemus) 같은 가스자이언트 작성법까지.
