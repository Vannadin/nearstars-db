...
| 13 | **Al** | Aluminum | <span style="display:inline-block;width:1em;height:1em;background:#e8e8e8;border:1px solid #444;vertical-align:middle"></span> `#e8e8e8` | 관측 가능 | chart_approx | Al I 396.2/394.4nm UV-violet; combustion appears bright white from Al2O3 incandescence |
...
| 22 | **Ti** | Titanium | <span style="display:inline-block;width:1em;height:1em;background:#a3d8e8;border:1px solid #444;vertical-align:middle"></span> `#a3d8e8` | 관측 가능 | chart_approx | Ti I emission predominantly UV-blue; visible discharge pale blue-cyan |
...
| 24 | **Cr** | Chromium | <span style="display:inline-block;width:1em;height:1em;background:#ffb74d;border:1px solid #444;vertical-align:middle"></span> `#ffb74d` | 관측 가능 | chart_approx | Cr I multi-line red-orange dominant; Cr metal vaporization yields orange-yellow |
...
| 32 | **Ge** | Germanium | <span style="display:inline-block;width:1em;height:1em;background:#c0c0c0;border:1px solid #444;vertical-align:middle"></span> `#c0c0c0` | 관측 가능 | chart_approx | Ge I lines mostly in UV; visible emission pale gray-blue |
| 33 | **As** | Arsenic | <span style="display:inline-block;width:1em;height:1em;background:#8fd8e8;border:1px solid #444;vertical-align:middle"></span> `#8fd8e8` | 관측 가능 | chart_approx | As I 286nm UV + visible 235nm; flame appears pale blue from arsenic oxide |
| 34 | **Se** | Selenium | <span style="display:inline-block;width:1em;height:1em;background:#5b9fe8;border:1px solid #444;vertical-align:middle"></span> `#5b9fe8` | 관측 가능 | chart_approx | Se I 473.1nm + 479.9nm blue; flame appears blue |
...
| 39 | **Y** | Yttrium | <span style="display:inline-block;width:1em;height:1em;background:#e8d83b;border:1px solid #444;vertical-align:middle"></span> `#e8d83b` | 관측 가능 | chart_approx | Y I red-orange lines + YO bands; flame yields carmine-red transitioning to yellow |
...
| 42 | **Mo** | Molybdenum | <span style="display:inline-block;width:1em;height:1em;background:#cfe83b;border:1px solid #444;vertical-align:middle"></span> `#cfe83b` | 관측 가능 | chart_approx | Mo I + MoO bands in yellow-green |
...
| 50 | **Sn** | Tin | <span style="display:inline-block;width:1em;height:1em;background:#5b8fe8;border:1px solid #444;vertical-align:middle"></span> `#5b8fe8` | 관측 가능 | chart_approx | Sn I 326nm UV + 452/563nm; flame pale blue-white |
| 51 | **Sb** | Antimony | <span style="display:inline-block;width:1em;height:1em;background:#a3d8e8;border:1px solid #444;vertical-align:middle"></span> `#a3d8e8` | 관측 가능 | chart_approx | Sb I 252.8/259.8nm UV + visible bands; flame pale blue-green |
| 52 | **Te** | Tellurium | <span style="display:inline-block;width:1em;height:1em;background:#9be88f;border:1px solid #444;vertical-align:middle"></span> `#9be88f` | 관측 가능 | chart_approx | Te I bands in green; flame pale green from tellurium oxide |
...
| 74 | **W** | Tungsten | <span style="display:inline-block;width:1em;height:1em;background:#3fe85f;border:1px solid #444;vertical-align:middle"></span> `#3fe85f` | 관측 가능 | chart_approx | W I lines in green-yellow; chart renders bright green |
| 75 | **Re** | Rhenium | <span style="display:inline-block;width:1em;height:1em;background:#3fe87f;border:1px solid #444;vertical-align:middle"></span> `#3fe87f` | 관측 가능 | chart_approx | Re I multi-line; chart renders green |
...
| 90 | **Th** | Thorium | <span style="display:inline-block;width:1em;height:1em;background:#e8e8e8;border:1px solid #444;vertical-align:middle"></span> `#e8e8e8` | 관측 가능 | chart_approx | ThO2 (thoria) gas mantle emits brilliant white from thermal continuum + selective IR |
| 91 | **Pa** | Protactinium | — | 방사능 위험 | — | All Pa isotopes radioactive; no flame test characterized |
| 92 | **U** | Uranium | <span style="display:inline-block;width:1em;height:1em;background:#cfe83b;border:1px solid #444;vertical-align:middle"></span> `#cfe83b` | 관측 가능 | chart_approx | U I + UO2 fluorescence green-yellow; uranium glass fluoresces green under UV |
