...
2010 (A&A 522, A13, [`2010A&A...522A..13R`](https://ui.adsabs.harvard.edu/abs/2010A%26A...522A..13R), arXiv **[1007.1514](https://arxiv.org/abs/1007.1514)**, cached) 은 이를
...
| GJ 896 A b | 2.26 | 1.10 | 0.50 (범위 0.1–0.95) | **1980 µT** (1600–3400) | ~117 000 | low |
| ε Ind A b | 7.6 | 1.12 | 3.5 | **3220 µT** (2600–3700) | ~201 000 | low–med |

> 손으로 적은 표가 아니라 `engine/dynamo_table.py` 가 생성한다. 위 앵커가 바뀌면
> 다시 돌려라 — 셀이 레시피 출력에서 벗어나면 소리 내며 실패한다. ε Ind A b 의
> 쌍극자 모멘트 셀은 원래 `~3700 / 2600 → med` 였는데, µT 범위가 모멘트 칸으로
> 새어 들어가 모멘트를 **54배** 낮게 적고 있었다. GJ 896 A b 의 나이는 대표값을
> 계산한 지점인 **0.50 Gyr** 를 명시한다. 범위만 적어두면 두 독자가 산술 중앙과
> 로그 중앙 중 다른 쪽을 골라 17 % 차이가 난다.
