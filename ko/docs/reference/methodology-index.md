...
| [body-class-methodology](body-class-methodology.md) | 이 천체가 어느 클래스인가, 그래서 어느 물리가 적용되는가. 질량과 반지름을 발표된 경계에 대서 좁히고 선언된 클래스와 대조합니다 | Chen & Kipping 2017 ([arXiv:1603.08614](https://arxiv.org/abs/1603.08614)); Fulton 2017 ([arXiv:1703.10375](https://arxiv.org/abs/1703.10375)); Rogers 2015; Van Eylen 2018; Lambrechts & Johansen 2014 ([arXiv:1408.6087](https://arxiv.org/abs/1408.6087)); Otegi 2020; Spiegel 2011; Chabrier & Baraffe 2000 |
| [interior-structure-methodology](interior-structure-methodology.md) | 층 적분: 질량과 조성에서 반지름·핵 경계·C/MR²·중심압 | Seager 2007 ([arXiv:0707.2895](https://arxiv.org/abs/0707.2895)); Zeng 2016 ([arXiv:1512.08827](https://arxiv.org/abs/1512.08827)); Zeng & Sasselov 2013 ([arXiv:1301.0818](https://arxiv.org/abs/1301.0818)); Feistel & Wagner 2006 (IAPWS-06); Dziewonski & Anderson 1981 (PREM) |
| [core-state-methodology](core-state-methodology.md) | 암석체의 금속 핵이 전도성 액체인가. 핵의 P–T 를 철의 융해곡선에 대고 내핵 경계를 찍는다 | Zhang 2015 ([`2015PEPI..244...69Z`](https://ui.adsabs.harvard.edu/abs/2015PEPI..244...69Z)); González-Cataldo & Militzer 2023 ([`2023PhRvR...5c3194G`](https://ui.adsabs.harvard.edu/abs/2023PhRvR...5c3194G)); Kraus 2022; Anzellini 2013; Sinmyo 2019; Alfè 2002 ([cond-mat/0107307](https://arxiv.org/abs/cond-mat/0107307)) |
...
| [tidal-response-methodology](tidal-response-methodology.md) | 층 유동학에서 degree-2 조석 Love 수(k₂·h₂·l₂)와 소산 Q 를 **레올로지 밴드**로 냄. 배출만이라 선언된 `k₂/Q` 를 대체하지 않음 | Beuthe 2015; Saito 1974; Bagheri+ 2022; Wahr 1981 |
| [tidal-heating-methodology](tidal-heating-methodology.md) | 조석가열 플럭스 (Io/Enceladus 캘리브레이션) **+ 표면 열수송**: 어느 방식으로 열이 나가는지, 그리고 용암호 수용량이 천체 크기에 씌우는 상한 | Peale, Cassen & Reynolds 1979; Segatz 1988; Henning 2009; Spencer, Katz & Hewitt 2020; Reese 1998; Campion & Coppola 2023 |
