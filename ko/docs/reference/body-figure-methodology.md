...
- **Murray & Dermott 1999**, *Solar System Dynamics* ([`1999ssd..book.....M`](https://ui.adsabs.harvard.edu/abs/1999ssd..book.....M)) §4: 자전 및
  동기 천체의 정유체 형상; 이 연쇄식의 교과서 본거지.
- **Tricarico 2014**, ApJ 782, 99 ([`2014ApJ...782...99T`](https://ui.adsabs.harvard.edu/abs/2014ApJ...782...99T)): 동기 형상을 현대적으로 엄밀하게 진술,
  곧 J₂/C₂₂ ≈ 10⁄3, (b−c)/(a−c) ≈ 1⁄4, 그리고 고차 Ω²/(πGρ) 보정입니다. **Dermott 1979**,
  Icarus 37, 575 ([`1979Icar...37..575D`](https://ui.adsabs.harvard.edu/abs/1979Icar...37..575D))와 짝지어 사용: 위성 형상과 중력 모멘트의 고전적 유도.
- **Pijpers 1998**, MNRAS 297, L76 ([`1998MNRAS.297L..76P`](https://ui.adsabs.harvard.edu/abs/1998MNRAS.297L..76P)): 헬리오사이즈몰로지 태양
...
- **Chandrasekhar 1939**, *An Introduction to the Study of Stellar Structure*
  ([`1939isss.book.....C`](https://ui.adsabs.harvard.edu/abs/1939isss.book.....C)): 폴리트로프 관성모멘트. n = 3/2(완전 대류 M 왜성·비상대론 백색왜성)의
  NMoI ≈ 0.205로, 둘 다 Radau–Darwin 유효범위 안으로 되돌립니다(§2).
- **Hermes et al. 2017**, ApJS 232, 23 ([`2017ApJS..232...23H`](https://ui.adsabs.harvard.edu/abs/2017ApJS..232...23H)): 점근파 백색왜성 자전 분포.
  표본 중앙값 P ≈ 35 h가 자전 미측정 WD의 문서화된 통계 입력입니다(§2).
- **Sterne 1939**, MNRAS 99, 451 ([`1939MNRAS..99..451S`](https://ui.adsabs.harvard.edu/abs/1939MNRAS..99..451S)): 근점이동/내부구조 상수.
  J₂ = (2/3)k₂q의 원류입니다(§2). 현대 러브수 형태는 **Ragozzine & Wolf 2009** ([`2009ApJ...698.1778R`](https://ui.adsabs.harvard.edu/abs/2009ApJ...698.1778R)).
- **Claret 2004**, A&A 424, 919 ([`2004A&A...424..919C`](https://ui.adsabs.harvard.edu/abs/2004A%26A...424..919C); 최신 그리드 Claret 2019
  [`2019A&A...628A..29C`](https://ui.adsabs.harvard.edu/abs/2019A%26A...628A..29C)): 이론 k₂ 그리드. A형 계수의 출처이며, 태양 이론-경험 오프셋(~1.27×)이
  정량화된 계통 오차입니다.
- **Hadjara et al. 2014**, A&A 569, A45 ([`2014A&A...569A..45H`](https://ui.adsabs.harvard.edu/abs/2014A%26A...569A..45H)): Fomalhaut 최초의 완전 3D 자전 해
...
- **Zharkov & Trubitsyn 1978**, *Physics of Planetary Interiors* ([`1978ppi..book.....Z`](https://ui.adsabs.harvard.edu/abs/1978ppi..book.....Z));
  **Hubbard 1984**, *Planetary Interiors* ([`1984plin.book.....H`](https://ui.adsabs.harvard.edu/abs/1984plin.book.....H)): 형상 이론, q–f–J₂–NMoI 연쇄식.
- **측정된 동기 형상 앵커**(J₂ = 10⁄3·C₂₂ 캘리브레이션): Io: Anderson
  et al. 2001 ([`2001JGR...10632963A`](https://ui.adsabs.harvard.edu/abs/2001JGR...10632963A); 형상 축 a−c = 14.4 km, b−c = 3.6 km → 4:1,
  ...
  직접 보고); Titan: Iess et al. 2010 *Science* ([`2010Sci...327.1367I`](https://ui.adsabs.harvard.edu/abs/2010Sci...327.1367I); a−c = 410 m,
  b−c = 103 m → 비율 3.98 ≈ 4:1, C/MR² ≈ 0.34). 모두 J₂/C₂₂ ≈ 10⁄3을 줍니다.
- **Moon(비-정유체 / 화석 팽대부)**: GRAIL 중력장, Zuber et al. 2013 *Science*
  ([`2013Sci...339..668Z`](https://ui.adsabs.harvard.edu/abs/2013Sci...339..668Z)); J₂/C₂₂에서 도출한 관성모멘트 + 내부 해석, Williams et al. 2014
  ([`2014JGRE..119.1546W`](https://ui.adsabs.harvard.edu/abs/2014JGRE..119.1546W), I_s/MR² = 0.392728). J₂/C₂₂ ≈ 9 ≠ 10⁄3.
- **Fomalhaut A 자전축**, Le Bouquin et al. 2009, A&A 498, L41 ([`2009A&A...498L..41L`](https://ui.adsabs.harvard.edu/abs/2009A%26A...498L..41L),
  VLTI/AMBER): A4V, 자전축 PA 65°로 디스크에 ⊥, 이는 측정된 극을 가진 빠른 자전체임을 확인하지만,
  편평도 수치는 발표되지 않았습니다(§6 주석 참조).
- **합성 고차 장 (§5)**: Kaula 1966, *Theory of Satellite Geodesy*
  ([`1966tsga.book.....K`](https://ui.adsabs.harvard.edu/abs/1966tsga.book.....K)): degree-variance 거듭제곱 법칙(Earth RMS ≈ 1×10⁻⁵/n²); GRAIL은
  달에 달 고유의 Kaula 제약을 적용하며(Lemoine et al. 2013, [`2013JGRE..118.1676L`](https://ui.adsabs.harvard.edu/abs/2013JGRE..118.1676L)),
...
|---|---|---|---|---|---|
| Earth | EGM2008 | 2159 | 1082.6 / 1.57 | [`2012JGRB..117.4406P`](https://ui.adsabs.harvard.edu/abs/2012JGRB..117.4406P) | 풍부한 지오이드 앵커 (K ≈ 1e-5) |
| Moon | GL0900 / GRGM900 | 900 | (in model) | [`2014GeoRL..41.1452K`](https://ui.adsabs.harvard.edu/abs/2014GeoRL..41.1452K), [`2013JGRE..118.1676L`](https://ui.adsabs.harvard.edu/abs/2013JGRE..118.1676L) | **mascon** → 불안정한 저궤도; 고유 Kaula 상수 |
| Mars | MRO120D / GMM-3 | 120 | (in model) | [`2016Icar..274..253K`](https://ui.adsabs.harvard.edu/abs/2016Icar..274..253K), [`2016Icar..272..228G`](https://ui.adsabs.harvard.edu/abs/2016Icar..272..228G) | Tharsis; 높은 중력-지형 상관 |
| Venus | MGNP180U | 180 | (in model) | [`1999Icar..139....3K`](https://ui.adsabs.harvard.edu/abs/1999Icar..139....3K) | 매우 높은 중력-지형 상관(두꺼운 리소스피어) |
| Mercury | HgM005 | 50 | (in model) | [`2014JGRE..119.2417M`](https://ui.adsabs.harvard.edu/abs/2014JGRE..119.2417M), [`2019GeoRL..46.3625G`](https://ui.adsabs.harvard.edu/abs/2019GeoRL..46.3625G) | 저차; k₂ = 0.451 |
| Io | Galileo | 2 | hydrostatic | [`1996Sci...272..709A`](https://ui.adsabs.harvard.edu/abs/1996Sci...272..709A) | degree-2뿐 |
| Europa | Galileo | 2 | hydrostatic | [`1998Sci...281.2019A`](https://ui.adsabs.harvard.edu/abs/1998Sci...281.2019A) | degree-2뿐 |
| Ganymede | Galileo / +Juno | 2 | (1996 model) | [`1996Natur.384..541A`](https://ui.adsabs.harvard.edu/abs/1996Natur.384..541A), [`2022GeoRL..4999475G`](https://ui.adsabs.harvard.edu/abs/2022GeoRL..4999475G) | degree-2; Juno가 국지적 이상을 시사 |
| Callisto | Galileo | 2 | **32.7 / 10.2** | [`2001Icar..153..157A`](https://ui.adsabs.harvard.edu/abs/2001Icar..153..157A) | degree-2; C/MR² = 0.355, 부분 분화 |
| Titan | Cassini | 3 | k₂ ≈ 0.6 | [`2012Sci...337..457I`](https://ui.adsabs.harvard.edu/abs/2012Sci...337..457I) | 조석 → 지하 바다 |
| Enceladus | Cassini | 3 | **5435 / 1550** | [`2014Sci...344...78I`](https://ui.adsabs.harvard.edu/abs/2014Sci...344...78I) | J₂/C₂₂ = 3.51, 약하게 비-정유체(남극 바다) |
| Vesta | Dawn | 20 | (in model) | [`2014Icar..240..103K`](https://ui.adsabs.harvard.edu/abs/2014Icar..240..103K) | 비-정유체(Rheasilvia) |
| Ceres | Dawn | ~16 | hydrostatic | [`2016Natur.537..515P`](https://ui.adsabs.harvard.edu/abs/2016Natur.537..515P) | 지각 평형 보정; MoI 0.37 |
