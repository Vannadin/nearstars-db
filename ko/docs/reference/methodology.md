...
`game_epoch_jd`는 모드마다 다르며 상태 벡터에는 영향을 주지 않습니다.
- Sol: `JD2433647.5`
- RSS: `JD2433282.5`
...
`game_epoch`은 별개이며 상태 벡터에 영향을 주지 않습니다.
- Sol: `JD2433647.5`
- RSS: `JD2433282.5`

MM 패치 작성 시, 이 차이 때문에 Sol과 RSS 변형은 별도로 처리해야 합니다.
...
| `meta.game_epoch_jd_rss` | 시스템 | JD2433282.5 |
