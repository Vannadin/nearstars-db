...
배치를 쓰지 않습니다. **껍질 하나를 씁니다.** 가니메데 방식이고, 포획 영역 전체를 한 번에 적합한 뒤
...
형태가 이미 나오고, 슬롯이 없으면 렌더할 집단도 하나뿐이므로, 두 번째 껍질은 스스로를 정당화해야
합니다.

**두 껍질이 정말 필요하다면**(한 집단의 양쪽 날개가 아니라 서로 다른 두 공급원 집단이라면) 겹치게
둡니다. 경계만 맞대면 안 됩니다. 각 껍질의 선량은 **자기** 경계에서 0부터 오르므로, 맞댄 두 껍질은
...
양성자로 포획됩니다(Lenchek 1961, [`1961JGR....66.4027L`](https://ui.adsabs.harvard.edu/abs/1961JGR....66.4027L)). 대기를 걷어내면 그 공급원도 함께
사라지고, 깊은 껍질을 우선적으로 채워 줄 다른 것이 없습니다. 항성풍과 확산이 먹이는 집단은
