...
가니메데에는 적용하지 않았습니다. 장애물이 항성풍이 아니라 목성 플라스마 흐름 속에 있는 알프벤 날개
영역이기 때문입니다. NearStars 바디도 제외했습니다. 그쪽 소스는 phase 4 보드입니다.
...
합니다. **관례는 아직 선택하지 않았습니다.** 유력 후보는 `L = 150 r₀`이며, `r₀`에만 의존하므로
