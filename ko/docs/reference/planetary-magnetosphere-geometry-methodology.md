...
미결이 하나 있습니다. 토성의 0.736 은 지구의 0.58 을 넘는데, 자전 지배 자이언트치고 의외이고, 셋 중
유일하게 동압이 오를 때 벌어짐이 *감소*하는 천체이기도 합니다. 값 자체는 튼튼합니다 — 압력 의존
부호가 반대인 두 독립 피팅이 네 자리까지 일치합니다(Arridge 0.7356, Kanani 0.7358). 다만 그 압력
의존의 계수는 아직 못 읽은 유료 전문에 있습니다.
