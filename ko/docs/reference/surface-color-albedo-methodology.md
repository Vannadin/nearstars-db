...
**포스처: 표면 외형은 interesting-first 축이다.** 조성→외형 매핑이 워낙 다대일이라
(지구 하나만 봐도 자유도가 엄청나다), 표면의 *look*(색조·패턴·텍스처·혼합 기하)은
도출이 아니라 의도적인 **흥미-우선 아트 선택**이다. 흥미로운 reading을 고르고
canonical 대안을 병기하는 프로젝트의 interesting-first cascade를 따른다. 이 문서는 그
look을 **지시하는 게 아니라 게이트**다. 아트 선택이 머물러야 할 (a) 물리적으로 타당한
**알베도 밴드**와 (b) 근거 있는 **색조 계열**(§2)을 깔아줄 뿐이다. **묶이는 단 하나는
면적가중 Bond 알베도**다. 이건 미감이 아니라 `T_eq ∝ (1−A)^¼`(§6)로 온도에 전파된다.
그래서 규칙은 *look은 흥미-우선, 단 고른 skin의 `A`를 온도로 cascade*다. 같은 일사량에서
밝은 얼음 reskin과 어두운 현무암 reskin은 서로 다른 `T_eq`를 져야 한다.
...
### 자기 차폐와 cusp 집중: 어디가 풍화를 맞는가

우주풍화의 두 동력은 미치는 범위가 다르다. **미세운석은 자기장을 모른다**(온몸을
균일하게 풍화시킨다). 반면 **하전입자 풍화는 자기 기하를 따라간다**. 전역 자기장은
이온 플럭스를 저위도·중위도에서 밀어내고, 열린 자기력선을 따라 **극 cusp**로
깔때기처럼 흘려보낸다. 그래서 자기장을 가진 무대기 천체는 가려진 곳은 *덜* 풍화되고
자기극은 *더 세게* 풍화된다. 이 문장의 두 절 모두 태양계에 직접 관측 앵커가 있다.

- **달 자기 이상 소용돌이(원형은 Reiner Gamma).** 지각 자기장이 태양풍을 국소로
  막아 주는 곳만 레골리스가 **밝고 덜 붉게** 남고, 주변의 폭격 지역은 어둡게
  성숙한다 — "차폐 = 신선, 폭격 = 어두움"의 관측 대비다(차폐 가설은 Hood &
  Schubert 1980, 자기장 위상 일치는 Hemingway & Garrick-Bethell 2012, 성숙도
  지도는 Glotch+ 2015·Denevi+ 2016).
- **가니메데 극관.** 극관 경계가 가니메데 고유 자기권의 열린/닫힌 자기력선 경계를
  따라간다(Khurana+ 2007). 입자는 그 경계의 극 쪽으로 강하해 표면을 바꾼다. 얼음
  가니메데에서는 광학 부호가 뒤집히지만(스퍼터링이 밝은 서리를 재배치), **자기권이
  표면 변질을 극관 꼴로 조직한다**는 관측 증거다.

자기장을 가진 무대기 암석의 실전 규칙: 미세운석발 어둡힘은 전역으로 두고, 가려진
중위도 벨트에서는 이온발(미세 npFe⁰, 붉힘) 성분 대부분을 빼고, 자기극에는 포화
선량을 몰아준다 — 중위도는 무자기장 아날로그(수성)보다 신선하고 밝게, 극은 더
어둡게(작업 사례: Proxima d의 투톤 표면, 보드 `phase4/proxima_cen.yaml`).
...
**NearStars α Cen 적용(정성적).** **황 침전물을 가진 현무암질 화산 바디**는 Alpha Centauri A b I(단테)풍
...
- **Burns, R. G. (1993)**: *Mineralogical Applications of Crystal Field Theory*, 2nd
  ed., Cambridge Univ. Press. **Book, no arXiv** (bibcode [`1993macf.book.....B`](https://ui.adsabs.harvard.edu/abs/1993macf.book.....B)). The
...
- **Sherman, D. M. (1985)**: *Physics and Chemistry of Minerals* 12, 161. **No
  arXiv** (bibcode [`1985PCM....12..161S`](https://ui.adsabs.harvard.edu/abs/1985PCM....12..161S)). Electronic structure of Fe³⁺ coordination
...
- **Morris, R. V. et al. (1985)**: *JGR* 90, 3126. **No arXiv** (bibcode
  [`1985JGR....90.3126M`](https://ui.adsabs.harvard.edu/abs/1985JGR....90.3126M)). Spectral/physicochemical properties of submicron ferric-oxide
...
- **Morris, R. V. et al. (2000)**: *JGR Planets* 105, 1757. **No arXiv** (bibcode
  [`2000JGR...105.1757M`](https://ui.adsabs.harvard.edu/abs/2000JGR...105.1757M)). Mineralogy/alteration of Mars Pathfinder rocks and soils:
  in-situ confirmation of the oxidized-iron Mars color. §2, §7. (267 cites.)

- **Clark, R. N. (1981)**: *JGR* 86, 3087. **No arXiv** (bibcode [`1981JGR....86.3087C`](https://ui.adsabs.harvard.edu/abs/1981JGR....86.3087C)).
...
- **Kokaly, R. F. et al. (2017)**: *USGS Data Series 1035*. **USGS report, no arXiv**
  (bibcode [`2017usgs.rept...14K`](https://ui.adsabs.harvard.edu/abs/2017usgs.rept...14K), DOI 10.3133/ds1035). **USGS Spectral Library Version
  7**: the canonical openly citable laboratory reflectance library of minerals, rocks,
  soils and ices (successor to splib06, Clark+ 2007 [`2007usgs.rept...16C`](https://ui.adsabs.harvard.edu/abs/2007usgs.rept...16C)). §3. (352
  cites.)

- **Hapke, B. (1981)**: *JGR* 86, 3039. **No arXiv** (bibcode [`1981JGR....86.3039H`](https://ui.adsabs.harvard.edu/abs/1981JGR....86.3039H)).
...
- **Hapke, B. (2012)**: *Theory of Reflectance and Emittance Spectroscopy*, 2nd ed.,
  Cambridge Univ. Press. **Book, no arXiv** (bibcode [`2012tres.book.....H`](https://ui.adsabs.harvard.edu/abs/2012tres.book.....H), DOI
  10.1017/CBO9781139025683; 1st ed. 1993 [`1993tres.book.....H`](https://ui.adsabs.harvard.edu/abs/1993tres.book.....H), 507/682 cites). The
...
- **Hapke, B. (2001)**: *JGR Planets* 106, 10039. **No arXiv** (bibcode
  [`2001JGR...10610039H`](https://ui.adsabs.harvard.edu/abs/2001JGR...10610039H)). *Space Weathering from Mercury to the Asteroid Belt*: the
...
- **Pieters, C. M. et al. (2000)**: *Meteoritics & Planetary Science* 35, 1101. **No
  arXiv** (bibcode [`2000M&PS...35.1101P`](https://ui.adsabs.harvard.edu/abs/2000M%26PS...35.1101P)). *Space Weathering on Airless Bodies*:
...
- **Warren, S. G. (1984)**: *Applied Optics* 23, 1206. **No arXiv** (bibcode
  [`1984ApOpt..23.1206W`](https://ui.adsabs.harvard.edu/abs/1984ApOpt..23.1206W)). Optical constants of water ice from the UV to the microwave:
  the canonical ice `n+ik` (revised compilation Warren & Brandt 2008,
  [`2008JGRD..11314220W`](https://ui.adsabs.harvard.edu/abs/2008JGRD..11314220W), 820 cites). §3, §4, §7. (1319 cites.)

- **Grundy, W. M. & Schmitt, B. (1998)**: *JGR Planets* 103, 25809. **No arXiv**
  (bibcode [`1998JGR...10325809G`](https://ui.adsabs.harvard.edu/abs/1998JGR...10325809G)). Temperature-dependent near-IR absorption spectrum
...
- **Grundy, W. M. et al. (1999)**: *Icarus* 142, 536. **No arXiv** (bibcode
  [`1999Icar..142..536G`](https://ui.adsabs.harvard.edu/abs/1999Icar..142..536G)). Near-IR spectra of icy outer-solar-system surfaces: the
...
- **Cruikshank, D. P. et al. (1993)**: *Science* 261, 742. **No arXiv** (bibcode
  [`1993Sci...261..742C`](https://ui.adsabs.harvard.edu/abs/1993Sci...261..742C)). *Ices on the Surface of Triton*: N₂/CH₄/CO₂/H₂O/CO ices on
  a bright high-albedo surface. §4, §7. (256 cites.)

- **Cruikshank, D. P. et al. (1998)**: *Icarus* 135, 389. **No arXiv** (bibcode
  [`1998Icar..135..389C`](https://ui.adsabs.harvard.edu/abs/1998Icar..135..389C)). *The Composition of Centaur 5145 Pholus*: the tholin/organic
...
- **de Pater, I. & Lissauer, J. J.**: *Planetary Sciences*, Cambridge Univ. Press
  ...
  [`2010plsc.book.....D`](https://ui.adsabs.harvard.edu/abs/2010plsc.book.....D)). Standard text for the geometric-albedo, phase-integral and
...
- **Polyanskiy, M. N. (2024)**: *Scientific Data* 11, 94. **No arXiv** (bibcode
  [`2024NatSD..11...94P`](https://ui.adsabs.harvard.edu/abs/2024NatSD..11...94P)). The **refractiveindex.info** database: the optical-constant
...
- **RELAB Spectral Library Bundle**: PDS Geosciences Node / Brown University (bibcode
  [`2020pds..data...98M`](https://ui.adsabs.harvard.edu/abs/2020pds..data...98M), DOI 10.17189/1519032). **Database, no journal-paper
