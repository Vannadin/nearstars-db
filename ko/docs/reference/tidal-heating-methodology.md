...
- 절대적인 기복은 스케일링된다. Dante의 `J₂ = 0.039`를
  [`body-figure-methodology.md`](body-figure-methodology.md)의 부피보존 동기형상
  (`a/R = 1 + 7J₂/3`, `b/R = 1 − 2J₂/3`, `c/R = 1 − 5J₂/3`)에 넣으면 `a = 568.4`,
  `b = 507.4`, `c = 487.1 km`가 나와 sub-planet에서 극까지 기복이 **81.2 km**다.
  극반경에 구형 해수면을 부여했을 때 협곡 벽에 쓸 수 있는 높이 예산이 이 값이다.
