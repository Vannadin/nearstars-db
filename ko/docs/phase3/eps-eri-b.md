...
| `magnetic_field_strength_microtesla_equator` | 400 | medium | jovian 다이나모 스케일링. Jupiter 표면 자기장 ≈ 430 μT (적도). 0.66 M_Jup 의 강한 대류 + Jupiter-like 자전이라면 cfg 는 400 μT 채택. Jupiter 의 약 7% 아래로 낮은 질량에서의 약간 약한 대류 구동을 반영 |
| `magnetic_dipole_moment_normalized_earth` | 13200 | medium | 0.66 × 20 000 ≈ 13 200 × Earth 의 선형 질량 스케일링 |
...
질량 스케일링하면 ε Eri b 는 ≈ 400 μT 와 ≈ 1.32 × 10⁴ × Earth 가
