...
Fuhrmeister 2022 ([arXiv:2204.09270](https://arxiv.org/abs/2204.09270)) 의 X 선 + FUV 동시 flare 분광은
이 사건들의 코로나 – 색채권 동시 반응을 기록합니다.

Proxima 가 α Cen AB 와 어떤 관계를 갖는가는 중력 결합이 시사하는 만큼
확실하지는 않습니다. Feng & Jones 2018 ([arXiv:1709.03560](https://arxiv.org/abs/1709.03560)) 가 조우
...
Flare 가 정의적 특징입니다. Vida 2019 ([arXiv:1907.12580](https://arxiv.org/abs/1907.12580)) 가 TESS 광도로
...
의 플라즈마 진동에 기인합니다. Burton et al. 2025 ([arXiv:2503.21890](https://arxiv.org/abs/2503.21890)) 가
...
([arXiv:2211.15697](https://arxiv.org/abs/2211.15697)) 는 b 거리에서의 항성풍 ram pressure 가 sub-Alfvénic
...
- **Fuhrmeister B. et al. 2022** — *The high energy spectrum of
  ...
  wavelengths*, A&A 663, A119 ([arXiv:2204.09270](https://arxiv.org/abs/2204.09270)). 코로나 + 색채권
  flare 응답.
- **Wargelin B. J. et al. 2024** — *X-Ray, UV, and Optical
  Observations of Proxima Centauri's Stellar Cycle*, A&A in press
  ([arXiv:2411.04252](https://arxiv.org/abs/2411.04252)). 정련된 7 년 활동 사이클.
...
- **Burton K. et al. 2025** — *The Proxima Centauri Campaign: First
  ...
  ([arXiv:2503.21890](https://arxiv.org/abs/2503.21890)). mm 밴드 flare 발생률.

### Read (context / methodology, not decision-driving)

- **Feng F. & Jones H. R. A. 2018** — *Was Proxima captured by α
  Centauri A and B?* ([arXiv:1709.03560](https://arxiv.org/abs/1709.03560)). 궤도 역사 역학.
- **Kervella P. et al. 2017** — *Proxima's orbit around α Centauri*,
  A&A 598, L7 ([arXiv:1611.03495](https://arxiv.org/abs/1611.03495)). 결합 삼중성을 확인하는 astrometric
  추적.

### Read (instrument / non-cfg-decisive)

- **De Luca P. et al. 2024** — Proxima b 지구 analog 의 오존-기후 동역학
  ([arXiv:2404.17972](https://arxiv.org/abs/2404.17972)). Proxima-b 합성에 재사용되는 대기 화학 framework.
- **Boldog Á. et al. 2024** — 암석 HZ 행성의 물 함량 모델링
  ([arXiv:2312.01893](https://arxiv.org/abs/2312.01893)). Proxima-b 내부 합성에 교차 인용.
