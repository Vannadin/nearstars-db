...
| `surface_radiation_dose_msv_yr` | 5000 | low | 얇은 대기 column (~100 g/cm²) + 약한 자기장 → AU Mic super-flare 하 높은 표면 dose. Atri 2019 ([1910.09871](https://arxiv.org/abs/1910.09871)) 가 SEP→dose 프레임워크(event 당 Gray + enhancement 계수이지 연간 mSv/yr 가 아니다)를 제공하므로, 여기 적힌 연간값은 변환 추정 → low |
