...
| `star_apparent_angular_diameter_deg` | 4.2 | high | 유도. 2 × 0.82 R☉ / 0.105 AU × (180/π) ≈ 4.2° (R 은 Phase 2 anchor Donati 2023 ZDI) |
...
- **Donati J.-F. et al. 2023** — *The magnetic field topology and filling of the very active M dwarf AU Mic*, MNRAS 525, 2015 (`2023MNRAS.525.2015D`). host 별 ZDI. 행성 복사 환경에 대한 항성 자기장 맥락 제공.
