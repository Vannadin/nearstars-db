...
| `magnetic_dipole_moment_normalized_earth` | 0.02 | low | RM22 ([2203.01065](https://arxiv.org/abs/2203.01065)) 의 sub-Earth-mass 조석 고정 케이스; Driscoll & Olson 의 dynamo shutoff 시나리오 선호 |
...
| `surface_radiation_dose_msv_yr` | 25000 | low | Atri 2019 ([1910.09871](https://arxiv.org/abs/1910.09871)) 을 d 의 0.022 AU + 얇은 대기(~10 g/cm²) 에 맞춰 보간 |
...
**조석 가열 정교화.** Dobos 2019 ([1902.03867](https://arxiv.org/abs/1902.03867)) 가 Maxwell viscoelastic
...
**내부-대기 결합.** Acuña 2021 ([2101.08172](https://arxiv.org/abs/2101.08172)) 이 d 의 hydrosphere 를
...
(4.05 d) 으론 강한 dynamo 가 어려움. RM22 ([2203.01065](https://arxiv.org/abs/2203.01065)) 가 sub-Earth-mass
...
- **[2508.08416](https://arxiv.org/abs/2508.08416)** Piaulet-Ghorayeb 2025 — JWST NIRSpec/PRISM transmission
  ...
  견인.
- **[2511.10801](https://arxiv.org/abs/2511.10801)** Salman 2024 — 탄소 사이클이 있는 대기-내부 모델.
  mantle 산소 fugacity 와 초기 물 질량 분율의 함수로 outgassing 조성
  제약. H₂-rich 보다 trace-CO₂ + H₂O 조성 지지.
- **[1902.03867](https://arxiv.org/abs/1902.03867)** Dobos 2019 — Maxwell viscoelastic 조석 가열 모델.
  F_int(d) = 0.26 W/m², mantle T 1645 K (부피 기준 최대 35% melt).
  d 의 albedo 에 대한 runaway-greenhouse 임계값 식별 (volatile 저장고
  존재 시 A_B ≥ 0.3 필요).
- **[2101.08172](https://arxiv.org/abs/2101.08172)** Acuña 2021 — 7개 행성의 hydrosphere 특성화. d 의 WMF
...
- **[1706.04617](https://arxiv.org/abs/1706.04617)** Garraffo 2017 — Threatening Magnetic and Plasma
  ...
  MHD 시뮬레이션.
- **[2203.01065](https://arxiv.org/abs/2203.01065)** RM22 — 암석 행성의 자기 모멘트. Sub-Earth-mass 조석
  고정 dynamo 스케일링.
- **[1910.09871](https://arxiv.org/abs/1910.09871)** Atri 2019 — 항성 양성자 이벤트의 표면 도즈 테이블.
- **[1710.08761](https://arxiv.org/abs/1710.08761)** Kislyakova 2018 — Induction heating. d 가 항성풍의
  전자기 결합으로 radiogenic flux 의 56% 를 수령; d 내부 마그마 바다
  대안 시나리오 지지.

### 읽음 (맥락 / 방법론, 결정 견인 안 함)

- **[1802.02250](https://arxiv.org/abs/1802.02250)** de Wit 2018 — HST WFC3 대기 정찰. H₂-rich 대기에 대한
  초기 제약(d 에 대해 8σ). Piaulet 2025 로 대체되었지만 역사적으로
  첫 비검출.
- **[1810.05210](https://arxiv.org/abs/1810.05210)** Moran 2018 — 업데이트된 질량과의 HST 안개/구름 한계.
  HST 와 일관된 tropospheric 구름과 metallicity > 60× solar 보임. JWST
  로 대체.
- **[2103.08600](https://arxiv.org/abs/2103.08600)** Welbanks 2021 — Aurora 검색 프레임워크. CO₂-rich 또는
  N₂-rich d 대기에 대한 10-transit JWST NIRSpec 검출 feasibility 예측.
  Piaulet 2025 관측이 이 예측의 실험적 실현(2 transit 으로 예측된
  민감도 달성).
- **[2206.00028](https://arxiv.org/abs/2206.00028)** Meadows 2022 — 대기 교환 biosignature false-positive
  (d 의 O₂ 가 e 로 운반). 그럴듯한 volatile 운반 메커니즘 제약하지만
  직접 시각적 정보 아님.
- **[2210.02484](https://arxiv.org/abs/2210.02484)** Hill 2022 — Habitable-zone exoplanet 카탈로그. d 를
  LHS 1140 b 및 K2-3 d 와 함께 후속 관측에 유리한 transiting ≤2 R⊕ HZ
  행성 셋 중 하나로 등재. 맥락만.
- **[2304.12490](https://arxiv.org/abs/2304.12490)** Hardegree-Ullman 2023 — ELT O₂ 검출 가능성 서베이.
