...
2025 ([arXiv:2510.11940](https://arxiv.org/abs/2510.11940)) 는 Phase 2 권장 별 광도 (입사 플럭스 = 1481
...
3. **이론적 거주가능성.** Wandel 2019 ([arXiv:1906.07704](https://arxiv.org/abs/1906.07704)) 는 1D 기후-
...
- **Boukrouche R., Caballero R., Lewis N. T. 2025** — *Near the
  ...
  ([arXiv:2510.11940](https://arxiv.org/abs/2510.11940)). 1481 W/m² 의 3-D GCM — α_s = 0.07 와 0.30
...
- **Boukrouche R., Caballero R., Janson M. 2024** — *The Impact of
  ...
  Star b as Observed by LIFE* ([arXiv:2411.07922](https://arxiv.org/abs/2411.07922)). 1-D 물 구름 모델;
...
- **Fujii Y. et al. 2026** — *Probing thermal gradients of habitable-
  ...
  using direct imaging* ([arXiv:2512.16575](https://arxiv.org/abs/2512.16575)). 1 과 10 bar 의 b 에 대한
...
- **Hammond T. et al. 2025** — *The climates and thermal emission
  ...
  ([arXiv:2504.00978](https://arxiv.org/abs/2504.00978)). 티가든의 별 **c** (b 아님) 를 포함한 일곱 표적의
  ExoCAM GCM 격자; c 는 모든 pCO₂ 에서 완전히 얼음으로 덮인 눈덩이.
  b 로 외삽되는 초회전 / Matsuno-Gill / 동쪽 구름 동역학 체제에 사용.
  b 는 그들의 격자에 없습니다.
- **Schweitzer A. et al. 2019** — 별 매개변수 ([arXiv:1904.03231](https://arxiv.org/abs/1904.03231)), 모성
  통해 사용 (권장 해 R = 0.107 R☉).
- **Fuhrmeister B. et al. 2025** — *Coronal and chromospheric activity
  of Teegarden's star* ([arXiv:2504.02338](https://arxiv.org/abs/2504.02338)). 대기 보존을 위한 활동 맥락;
