...
Pourbaix & Boffin 2016 와 Kervella 2017 의 기본 파라미터는 매우 타이트
합니다. M_B = 0.9373 ± 0.0028 M☉, R_B = 0.8632 ± 0.0037 R☉ 두 값 모두
A 와 같은 분광 이중선 + 간섭계 해에서 공유됩니다. 유효 온도는 Porto de
Mello 2008 의 5236 ± 51 K 로 K1V locus 의 더운 끝에 자리합니다. 표면
...
| `luminosity_lsun` | 0.500 | high | R 과 Teff 로 유도 |
...
| `visual_surface_tint_hex_primary` | `#ffcfa0` (따뜻한 오렌지 K1V) | high | K1V 흑체 5236 K |
| `stellar_color_temp_k` | 5236 | high | 유도 |
...
하고 (Δ[Fe/H] = +0.25 vs. 태양), Teff 5236 K 이며, 3D 유체역학 granulation
...
HARPS 스펙트럼을 이용한 Thompson 2017 (arXiv:1702.01647) 의 plage 모델
...
Lisogorskyi 2019 (arXiv:1902.10711) 는 α Cen B 의 활동 유발 RV jitter 를
...
Eri) 과 시각적으로 비슷합니다. 5236 K 의 별 SED 가 게임 내 조명 엔진에
...
- **Kervella P. et al. 2017** — arXiv:1610.06185 (A bibliography 와
  공유). R_B = 0.8632 ± 0.0037 R☉. α(B) = 0.1545 ± 0.0044.
- **Pourbaix D. & Boffin H. M. J. 2016** — arXiv:1601.01636. 이중성
  궤도 fit 에서 M_B = 0.9373 ± 0.0028 M☉.
- **Joyce M. & Chaboyer B. 2018** — arXiv:1806.07567. 시스템 나이 5.3
  ± 0.3 Gyr.
...
- **Eggl S. et al. 2013** — *Circumstellar habitable zones of binary-
  star systems in the solar neighbourhood* (arXiv:1210.5411). 이중성
...
- **Liseau R. et al. 2016** — *ALMA's view of the nearest neighbors to
  ...
  1608.02384). 광구 원적외선 / sub-mm 연속체.
- **Wiegert J. et al. 2014** — α Cen 주위의 먼지, 적외선 초과 탐색
  (arXiv:1401.6896). 유의미한 debris 초과 미검출.

### Read (instrument / non-cfg-decisive)

- **Spada F. et al. 2019** — arXiv:1909.00701. K 왜성 반지름의 entropy
