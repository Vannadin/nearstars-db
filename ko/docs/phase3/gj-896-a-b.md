...
| `surface_gravity_g_earth` | ~4.7 | medium | 유도. g = G M / R² 에 M = 2.26 M_Jup, R = 1.1 R_Jup → ~46 m/s² ≈ 4.7 g⊕. 무거운 jovian (목성 표면 중력의 ≈2배) |
...
| `atmosphere_scale_height_km` | ~10 | medium | 유도. H = kT / (μ m_H g) 에 T ≈ 130 K, μ = 2.3, g ≈ 46 m/s² ≈ 10 km |
