...
영상은 **넓은 안쪽 디스크** (~10–78 AU, 경사 ~47.8° 로 외곽 고리와 어긋남) 와 ~83–104 AU 의 (~78 AU gap 으로 분리되는) **중간
...
거대합니다. **넓은 안쪽 디스크 (~10–78 AU, 경사 ~47.8°)** (Gáspár
2023) 는 넓고 희미한 저밀도 고리로 렌더링되며, 외곽 벨트들과 눈에
띄게 기울어져 보입니다 — JWST 의 대표적 미정렬 결과입니다. 안쪽
가장자리가 별과 가까워 그 산란광이 안쪽 행성계의 황도광에 기여합니다.
...
- **Gáspár A. et al. 2023** — *Spatially resolved imaging of the
  ...
  디스크 (~10–78 AU)** 로 재해석. Fomalhaut b 시점 위치에 점광원
  없음, 먼지 구름 해석과 일관.
