...
| `insolation_s_earth` | 6.5 | high | L = 0.092 L☉ 과 a = 0.119 AU 에서 유도 |
...
| `atmosphere_scale_height_km` | 60 | high | 유도. T = 450 K, μ = 2.5 (H/He + 무거운 admixture), g = 18.2 m/s² 의 kT/μg |
...
적습니다. 별이 c 의 하늘에서 3.7° 를 채우고 (지구에서 본 태양의 약
7 배) 지배적 조명원입니다. substellar 구름 꼭대기에서 표면 일사량은
지구의 6.5 배. red-shift 됩니다.

**대기 탈출.** c 가 0.119 AU 에서 지구의 6.5 배 일사를 받으므로,
...
궤도 따라 상당한 일사 변동을 구동 (1 +/- 36%). Periapsis 일사 ~9 S⊕,
apoapsis ~4 S⊕ — 2 배 변동. 두꺼운 대기가 이를 ~30 K 구름 꼭대기
...
- **전반 외관.** muted zonal 띠를 가진 따뜻한 sub-Neptune 디스크.
  AU Mic 의 각지름 3.7° (지구에서 본 태양의 7 배 — 여전히 지배적
...
- **띠 구조.** 적도 superrotation jet 이 옅은 적도 zone 과 더 어두운
  ...
  보입니다. 더 작은 대기 스케일 높이 (60 km vs. 290 km) 때문에 띠가
...
- **하늘의 별.** AU Mic 이 c 의 하늘에서 3.7° 를 차지 (지구에서 본
  태양의 7 배) — 주간 하늘을 지배하는 적당한 크기의 깊은 붉은
  디스크. substellar 구름 꼭대기에서 표면 일사량 지구의 6.5 배.
...
- **Plavchan P. et al. 2020** — *A planet within the debris disk around the pre-main-sequence star AU Microscopii*, Nature 582, 497 (`2020Natur.582..497P`, arXiv:2006.13428). TESS 의 b 발견. 시스템 전반의 항성 활동 환경과 AU Mic 광도곡선의 다-흑점 복잡도에 대한 맥락 제공.
