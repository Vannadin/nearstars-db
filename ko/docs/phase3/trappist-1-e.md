...
aqua-planet 으로, 해양을 보유하고 substellar 지점 부근에 열린 물,
...
| `cloud_cover_fraction` | 0.55 | medium | Wolf 2017 GCM Aquaplanet 의 stratocumulus + cirrus. Cohen 2022 UM 은 60% 로 일치 |
| `subsurface_ocean_probability` | 0.876 | medium | Boldog 2023 (2312.01893) — HZ 최상위 등급 |
| `cloud_morphology` | 이중 중위도 밴드 + substellar 의 준정상 클러스터 | medium | Cohen 2022 Met Office UM — 단일 적도 jet 이 아닌 double-jet regime |
...
- **압력** 1 bar (100 kPa) — 지구형 값으로, Glidden 2025 N₂-rich
  일관성 윈도우 안에 여유 있게 들어갑니다.
- **조성** N₂ 78% (지구형 배경), Ar 0.5%, CO₂ 1% (outer-HZ 온실
  가열을 위해 지구의 0.04% 보다 올림. Wolf 2017 은 거주 가능 표면
  유지에 1–10× CO₂ 증대가 필요하다고 보고), H₂O 0.1–1% (substellar
  표면 부근은 포화, 그 외는 훨씬 적음), O₂ ~5% (abiotic 광분해
  기원 O₂. cfg 에서 산소 생산 생물권을 가정하지 않으므로 현재 지구의
  21% 보다 낮게 둠).
- **구름.** Wolf 2017 GCM 은 전역 구름 커버리지 약 55% 를 만들어내며,
  열린 물 disk 위에는 주로 stratocumulus, 그 외에는 high cirrus 가
  자리잡습니다. cirrus 가 온실 가열에 5–10% 기여합니다.
...
**느린 자전 효과.** 6.1 일 자전 주기에서는 Coriolis 효과가 지구보다
약합니다 (Rossby number 상승). Wolf 2017 과 Cohen 2022 (2211.11887,
Met Office UM GCM) 는 e 가 지구의 단일 적도 jet 가 아닌 **이중 중위도
jet regime** (평균 zonal wind ~18 m/s) 에 자리잡는다고 일치된 결과를
보여줍니다. 두 개의 정상 Rossby gyre 가 60–70°N/S 에 형성되며, 동쪽
gyre 의 중심은 약 20일 주기로 30–60°E 와 120–150°E 사이를 진동합니다.
substellar 구름 disk 는 위도 ±30° 까지만 도달합니다 (같은 연구에서
Proxima b 의 ±60° 와 대조). KSP 비주얼 측면의 함의. 구름 패턴은 두
줄기의 중위도 stratocumulus 밴드와 substellar 의 준정상 구름 클러스터
가 주도하며, 미세한 20일 가변성은 일반적인 KSP 게임플레이 속도에서는
보이지 않습니다.
