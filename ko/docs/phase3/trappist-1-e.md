...
- **1902.03732** Fraschetti 2019 — TRAPPIST-1 HZ 의 Stellar Energetic Particle flux. e 에서 양성자 flux 가 지구의 약 10⁶배일 것으로 예측하지만 두 가지 완화 메커니즘 (stellar B-field 에 의한 containment, CME 억제) 을 동반합니다. 특정 값을 강제하지 않으면서도 cfg 에 자기장을 유지할 근거를 줍니다.
