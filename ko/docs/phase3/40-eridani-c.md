...
백색왜성 40 Eri B 와 230.29 년 주기의 시각-분광 궤도를 그립니다 (Mason,
Hartkopf & Miles 2017, e = 0.4294, a = 6.93″, 평균 분리 ≈ 33 AU). 안쪽
...
| `mass_msun` | 0.2041 ± 0.0064 | high | Mason, Hartkopf & Miles 2017 §3. BC 이중성 역학 fit, P = 230.29 yr, 총질량 0.776 ± 0.024 M☉ 를 Heintz 1974 질량비 + van Leeuwen 2007 시차로 분할 |
...
평균 분리 33 AU 에 있는 동반자 B (BC 궤도 Mason 2017, e = 0.4294 →
...
- **Mason B. D., Hartkopf W. I., Miles K. N. 2017** — *Binary Star
  ...
  DOI 10.3847/1538-3881/aa803e). 갱신된 230.29 년 BC 시각-분광 궤도.
  총질량 0.776 ± 0.024 M☉, e = 0.4294, a = 6.93″. Heintz 1974 질량비와
...
- **Bond H. E., Bergeron P., Bédard A. 2017** — *The aged
  ...
  (Cummings 2018) 가 B 의 M_progenitor ≈ 1.8 M☉ 을 시사하며, 시스템
...
- [40-eridani-b](40-eridani-b.md) — DA2.9 백색왜성 동반자. C 와 230.29 년 이중성 궤도
