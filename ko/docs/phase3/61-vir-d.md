...
| `insolation_s_earth` | 3.63 | high | L = 0.822 L☉ (von Braun 2014) 와 a = 0.476 AU 에서 유도 |
...
| `star_apparent_angular_diameter_deg` | 0.110 | high | 유도. 2 × R★ / a. 0.476 AU 의 0.9867 R☉ (von Braun 2014 CHARA) |
...
한참 오른쪽에 위치시킵니다. 0.822 L☉ G 왜성 0.48 AU 의 23 M⊕ 핵에서
XUV 구동 질량 손실율은 ~10⁵ g/s — Gyr 당 외피 질량의 약 10⁻⁴ 손실.
7.7 Gyr 시스템 나이에 걸쳐 총 손실은 외피의 ~10⁻³ 로 완전히 무시 가능.
...
**광화학 haze 화학.** 5568 K 솔라 트윈 SED 는 거의 지구-태양 UV-to-가시
...
스케일링) 입니다. 이는 7.7 Gyr 시스템 나이를 초과합니다 — d 는 1:1
...
- **Moses J. I. et al. 2013** — *Compositional diversity in the
  ...
  arXiv:1306.5178). sub-Neptune 광화학. d 의 더 차가운 성층권에서의
...
- **Lewis N. K. et al. 2014** — *GCMs of warm sub-Neptunes*, ApJ 795,
  150 (`2014ApJ...795..150L`, arXiv:1410.0008). 차가운 sub-Neptune
...
- **Bolmont E. et al. 2020** — *Tidal dissipation and obliquity
  evolution* (`2020A&A...644A.165B`, arXiv:2002.02015). d 의 조석-가열
...
- **Wyatt M. C. et al. 2012** — *Herschel imaging of 61 Vir*
  (`2012MNRAS.424.1206W`, arXiv:1206.2370). 호스트 합성에서 상속. 간략
...
- **Kreidberg L. et al. 2014** — *Clouds in the atmosphere of the
  ...
  (`2014Natur.505...69K`, arXiv:1401.0022). featureless sub-Neptune
