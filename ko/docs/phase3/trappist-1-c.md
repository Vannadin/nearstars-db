...
| `tidal_heating_w_m2` | 0.62 (+0.42/-0.53) (Dobos 2019) 또는 1.32 (+0.30/-0.47) (Barr 2018) | medium | Barr 2018 (1712.05641) 과 Dobos 2019 (1902.03867) — Grimm 2018 + Agol 2021 질량을 적용한 Maxwell viscoelastic 모델. Io 급 flux 수준이며, 맨틀의 T_eq 는 1659–1666 K (암석 solidus 위 → 부분 용융). |
| `core_mass_fraction` | 0.24 ± 0.08 | medium | Acuña 2021 (2101.08172) — Fe/Si 항성 제약 시나리오 |
...
| `induction_heating_magma_ocean_fraction` | 0.68 | medium | Kislyakova 2018 (1710.08761) — c 가 시스템 내에서 **induction heating 분율이 가장 높음** (방사성 flux 의 68%). cfg 에 이미 들어가 있는 Io 급 조석 가열을 뒷받침 |
...
다만 최근 갱신된 조석 가열 추정치 (Barr 2018 / 1712.05641, Dobos 2019
/ 1902.03867) 는 c 의 내부 heat flux 를 **Io 급 수준** 인 0.6–1.3
...
내부 조성도 7 개 행성 가운데 가장 두드러짐. Acuña 2021 (2101.08172)
...
**자기 유도 가열이 Io 해석을 뒷받침함.** Kislyakova 2018 (1710.08761)
...
**Population statistics 측면 지원.** Gialluca 2024 (2405.02401) 는
...
**마그마 바다 가능성의 시그니처.** Bolmont 2020 (2002.02015) 은
...
제한함. RM22 (2203.01065) 스케일링은 multipolar/weak 자기장 영역,
...
- **1910.09871** Atri 2019 — Stellar Proton Event 의 표면 흡수
