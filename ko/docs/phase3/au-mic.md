...
| `disk_aspect_ratio` | 0.031 (+0.005/−0.004) | medium | Daley 2019 ALMA — edge-on (i = 88.5°) 해상된 수직 구조. r ≈ 23–41 AU 에서 종횡비 h 가 일정한 Gaussian scale height H(r) = h·r (~40 AU 가장자리에서 H ≈ 1.24 AU 함의). 평면 Kopernicus Ring 은 소비하지 않으며, 완전성과 향후 볼류메트릭/Parallax 렌더링용으로 기록합니다 |
