...
- **하늘의 별.** YZ Cet 은 c 의 하늘에서 ~3.9° (지구에서 본 태양의 약
  8 배) 를 차지하는 옅은 따뜻한 주황 (3100 K → `#ffd081`) 으로, 표면을
...
- **[`2020A&A...636A.119S`](https://ui.adsabs.harvard.edu/abs/2020A%26A...636A.119S)** Stock et al. 2020 — c 의 궤도 (P = 3.05989 d,
...
- **[2305.00809](https://arxiv.org/abs/2305.00809)** Trigilio et al. 2023 — uGMRT SPI 확인. 같은 결론
