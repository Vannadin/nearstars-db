...
Anglada-Escudé 외 2016 (Nature 536, 437. [arXiv:1609.03449](https://arxiv.org/abs/1609.03449)) 가 10 년의
...
행성은 통과하지 않습니다 (Jenkins et al. 2019, [arXiv:1905.01336](https://arxiv.org/abs/1905.01336).
Gilbert et al. 2021, [arXiv:2110.10702](https://arxiv.org/abs/2110.10702) — 여러 Spitzer + TESS 캠페인이
...
대기를 보유했는가 — 는 진짜로 열려 있습니다. Atri 2020 ([1910.09871](https://arxiv.org/abs/1910.09871))
은 대기 없는 조건에서 다세포 생명에 lethal 한 표면 방사선 도즈를
계산하며, Lee 2021 ([2109.06963](https://arxiv.org/abs/2109.06963)) 은 ~10⁹ atoms cm⁻² s⁻¹ 의 Venus-analog
photochemical 산소 escape 를 모델링하고, Garraffo 2022 ([2211.15697](https://arxiv.org/abs/2211.15697)) 는
super-Alfvénic transit 동안 항성풍 ram pressure 가 태양값의 10⁴–10⁶
배 spike 함을 찾습니다. 반대편에서 Zuluaga 2018 ([1609.00707](https://arxiv.org/abs/1609.00707)) 은 적당한
...
| `surface_radiation_dose_msv_yr` | 5000 | low | Atri 2020 ([1910.09871](https://arxiv.org/abs/1910.09871)) SEP→dose 프레임워크, 1 bar 대기 차폐 + 약한 B 필드. superflare 동안 10⁵ 까지 spike. Atri 가 보고하는 값은 event 당 Gray + enhancement 계수이지 연간 mSv/yr 가 아니므로, 이 연간값은 변환 추정 → low |
...
2020 ([arXiv:2004.03007](https://arxiv.org/abs/2004.03007)) 은 substellar convective 플룸이 열린 물 디스크
...
Shields 2018 ([1808.09977](https://arxiv.org/abs/1808.09977)) 은 대안 hydrohalite-snowball 시나리오를
...
[2211.11887](https://arxiv.org/abs/2211.11887)) 가 ±30–60° 위도에 traveling 구름 밴드를 만들고, 더 맑은
야측 (Joshi 2020 dark-side inversion analog). cfg `cloud_morphology` 필드
가 세 컴포넌트 모두를 하나의 문자열로 잡습니다.

Photochemistry (Yates 2020, [1912.08743](https://arxiv.org/abs/1912.08743). Braam 2024, [2410.19108](https://arxiv.org/abs/2410.19108)) 는 낮밤
terminator 주변의 O₃ 생성이 지배하며, canonical M 왜성 "stratospheric
ozone ring" 이 미래 transmission spectroscopy 에서 관측 가능할 수 있는
UV 신호를 만듭니다 (Proxima b 가 비통과이지만). Scheucher 2020 ([2003.02036](https://arxiv.org/abs/2003.02036))
...
물 vapor transit 모호성 (Macdonald 2024, [2402.12253](https://arxiv.org/abs/2402.12253)) 은 Proxima b 가
...
간헐적 일조량이 만들어졌을 것입니다 — Braam 2025 ([2410.19108](https://arxiv.org/abs/2410.19108)) 가
...
자기 dynamo. Zuluaga 2018 ([1609.00707](https://arxiv.org/abs/1609.00707)) 은 지구형 핵 구조와 10+ 일
...
- **Anglada-Escudé G. et al. 2016** — *A terrestrial planet candidate
  ...
  ([arXiv:1609.03449](https://arxiv.org/abs/1609.03449)). 발견 논문. Best-fit P = 11.186 d, Msini =
  1.27 M⊕, a = 0.0485 AU.
- **Suárez Mascareño A. et al. 2025** — *Diving into the planetary
  system of Proxima with NIRPS* ([arXiv:2507.21751](https://arxiv.org/abs/2507.21751)). 현재 best 궤도
  fit. P = 11.18465 d, e = 0, Msini = 1.055 M⊕.
- **Suárez Mascareño A. et al. 2020** — *Revisiting Proxima with
  ESPRESSO* ([arXiv:2005.12114](https://arxiv.org/abs/2005.12114)). 중간 단계 정련.
- **Faria J. P. et al. 2022** — *A candidate short-period sub-Earth
  orbiting Proxima Centauri* ([arXiv:2202.05188](https://arxiv.org/abs/2202.05188)). b 질량을 1.07 M⊕ 로
  정련. 동반 Proxima d.
- **Boutle I. A. et al. 2017** — *Exploring the climate of Proxima B
  with the Met Office Unified Model*, A&A 601, A120
  ([arXiv:1702.08463](https://arxiv.org/abs/1702.08463)). UK Met Office UM GCM. substellar 열린 물 lens,
...
- **Turbet M. et al. 2016** — *The habitability of Proxima Centauri b.
  ...
  ([arXiv:1608.06827](https://arxiv.org/abs/1608.06827)). 1D 기후 framework. aquaplanet 부터 snowball
  까지 범위.
- **Meadows V. S. et al. 2018** — *The Habitability of Proxima
  Centauri b: Environmental States and Observational Discriminants*,
  AsBio 18, 133 ([arXiv:1608.08620](https://arxiv.org/abs/1608.08620)). 대기 보유 시나리오 + 관측
  discriminant.
...
- **Cohen M. et al. 2023** — *Traveling Planetary-scale Waves Cause
  ...
  ([arXiv:2211.11887](https://arxiv.org/abs/2211.11887)). Rossby-wave 구름 변동성.
- **Scheucher M. et al. 2020** — *Proxima Centauri b: A Strong Case
  for Including Cosmic-Ray-induced Chemistry in Atmospheric
  Biosignature Studies*, ApJ 893, 12 ([arXiv:2003.02036](https://arxiv.org/abs/2003.02036)). 우주선
...
- **Atri D. et al. 2020** — *Stellar Proton Event-induced surface
  radiation dose* ([arXiv:1910.09871](https://arxiv.org/abs/1910.09871)). 표면 도즈 계산.
- **Walterová M. & Běhounková M. 2020** — *Thermal and Orbital
  Evolution of Low-mass Exoplanets* ([arXiv:2007.12459](https://arxiv.org/abs/2007.12459)). 조석 고정
  시간 스케일.
...
- **Macdonald E. et al. 2024** — *Water vapour transit ambiguities
  for habitable M-Earths* ([arXiv:2402.12253](https://arxiv.org/abs/2402.12253)). 대기 습도 retrieval
  모호성.
- **Galuzzo D. et al. 2021** — *Three-dimensional Climate Simulations
  for the Detectability of Proxima Centauri b*, ApJ 909, 191
  ([arXiv:2102.03255](https://arxiv.org/abs/2102.03255)). 3D 검출 가능성 framework.
- **Braam M. et al. 2024** — *Earth-like Exoplanets in Spin–Orbit
  Resonances*, MNRAS 528, 3098 ([arXiv:2410.19108](https://arxiv.org/abs/2410.19108)). 기후 동역학 + 3D
  photochemistry.

### Read (context / methodology, not decision-driving)

- **Bonfils X. et al. 2018** — *A temperate exo-Earth around a quiet
  M dwarf at 3.4 parsec* ([arXiv:1711.06177](https://arxiv.org/abs/1711.06177)). 자매 시스템 컨텍스트.
- **Jenkins J. S. et al. 2019** — *Proxima Centauri b is not a
  transiting exoplanet* ([arXiv:1905.01336](https://arxiv.org/abs/1905.01336)). 통과 배제.
- **Gilbert E. A. et al. 2021** — *No Transits of Proxima Centauri
  planets in high cadence TESS data* ([arXiv:2110.10702](https://arxiv.org/abs/2110.10702)). Jenkins
  강화.
- **Hammond T. et al. 2025** — 근처 암석 외계행성의 thermal emission
  스펙트라 ([arXiv:2504.00978](https://arxiv.org/abs/2504.00978)). 다중 행성 스펙트라.
...
- **Fuhrmeister B. et al. 2022** — Proxima X 선 + FUV 동시 flare
  ([arXiv:2204.09270](https://arxiv.org/abs/2204.09270)).

### Read (instrument / non-cfg-decisive)

- **Hardegree-Ullman K. et al. 2025** — Bioverse 직접 촬영 전망
  ([arXiv:2405.11423](https://arxiv.org/abs/2405.11423)). 미래 관측 가능성 framework.
- **Singla M. et al. 2023** — 암석 외계행성 reflection 스펙트라
  ([arXiv:2303.00540](https://arxiv.org/abs/2303.00540)). 고대비 imaging.
- **Pearce L. A. et al. 2025** — 직접 검출 하늘 위치 예측
  ([arXiv:2509.06747](https://arxiv.org/abs/2509.06747)). 미션 계획.
...
- **Spin-orbit resonance 기후.** Braam 2024 ([2410.19108](https://arxiv.org/abs/2410.19108)) 이 비동기
