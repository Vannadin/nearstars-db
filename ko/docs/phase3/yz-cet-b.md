...
- **하늘의 별.** YZ Cet 은 b 의 하늘에서 ~5.1° (지구에서 본 태양의 약
  10 배) 를 차지하는 옅은 따뜻한 주황 (3100 K → `#ffd081`) 으로, 적외선이
...
- **[2305.00809](https://arxiv.org/abs/2305.00809)** Trigilio et al. 2023 — uGMRT 550–900 MHz 로 SPI 의 ARE
  ...
  간접 외계행성 B-장 측정입니다.
- **[2304.00031](https://arxiv.org/abs/2304.00031)** Pineda & Villadsen 2023 — b 의 2.02087 d 궤도로
