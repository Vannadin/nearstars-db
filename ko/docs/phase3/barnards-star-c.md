...
| `surface_radiation_dose_msv_yr` | 5000 | low | Atri 2020 (1910.09871) SEP→dose 프레임워크(무대기 + 4.7 S⊕ XUV) × France 2020 (2009.01259) flare 듀티 사이클. Atri 가 보고하는 값은 event 당 Gray + enhancement 계수이지 연간 mSv/yr 가 아니므로, 이 연간값은 변환 추정 → low |
