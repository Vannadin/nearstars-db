...
| `surface_radiation_dose_msv_yr` | 5000 | low | Atri 2020 ([1910.09871](https://arxiv.org/abs/1910.09871)) SEP→dose 프레임워크(무대기 + 4.7 S⊕ XUV) × France 2020 ([2009.01259](https://arxiv.org/abs/2009.01259)) flare 듀티 사이클. Atri 가 보고하는 값은 event 당 Gray + enhancement 계수이지 연간 mSv/yr 가 아니므로, 이 연간값은 변환 추정 → low |
...
- **Basant R. et al. 2025** — *Four Sub-Earth Planets Orbiting
  ...
  [arXiv:2503.08095](https://arxiv.org/abs/2503.08095)). MAROON-X 확인. P = 4.1244 d, Msini = 0.335 ±
...
- **Stefanov A. K. et al. 2024** — *On the possible transit of
  Barnard b* ([arXiv:2410.00577](https://arxiv.org/abs/2410.00577)). TESS S80 비검출. b 에 대해 i ≤ 87.9°
  (3σ), 4-행성 GH24 해로 확장 → c 도 비-transit.
- **Walterová M. & Běhounková M. 2020** — *Thermal and Orbital
  Evolution of Low-mass Exoplanets* ([arXiv:2007.12459](https://arxiv.org/abs/2007.12459)). 조석 잠금
...
- **Toledo-Padrón B. et al. 2019** — *Stellar activity analysis of
  Barnard's Star* ([arXiv:1812.06712](https://arxiv.org/abs/1812.06712)). 호스트 회전 + ~3800-일 활동
  사이클.
...
- **France 2020 검증**. escape 속도 (HZ 에서 87 지구대기 Gyr⁻¹) 와
  ...
  어떤 cfg writer 가 이를 load-bearing 으로 취급하기 전에 [arXiv:2009.01259](https://arxiv.org/abs/2009.01259)
