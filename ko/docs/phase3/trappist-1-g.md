...
Bourgeois 2024 ([2008.09599](https://arxiv.org/abs/2008.09599)) 의 magma-ocean 진화 결과는 water mass fraction
...
| `atmosphere_surface_pressure_pa` | 5 000 | medium | 0.05 bar — 174 K 에서 순수 CO₂ 의 안정 equilibrium 인 Turbet 2018 ([1707.06927](https://arxiv.org/abs/1707.06927)) 의 150 mbar 보다 아래. 화산 outgassing 이 계속된다는 가정 아래의 비평형 escape-balanced 상태. 150 mbar 이상이면 대기가 자가 유지되고, 0.01 bar 미만이면 사실상 무대기 행성이 됩니다 |
...
| `xuv_flux_at_planet_F_earth` | ~120 (현재) | high | Berardo 2025 ([2506.12140](https://arxiv.org/abs/2506.12140)). 개정된 L_XUV = 1.83×10²⁸ erg/s 로 2017 추정치보다 30배 높음 |
...
| `magnetic_field_strength_microtesla_equator` | 10 | low | RM22 ([2203.01065](https://arxiv.org/abs/2203.01065)) 스케일링. 1.32 M⊕ (시스템 최대 질량) 가 활성 dynamo 를 뒷받침 |
| `magnetic_dipole_moment_normalized_earth` | 0.35 | medium | RM22 + [2208.06523](https://arxiv.org/abs/2208.06523) (지구급 core 가 dynamo 수명을 늘림). 내부 hydrosphere convection 도 기여할 수 있음 |
...
| `surface_radiation_dose_msv_yr` | 5000 | low | Atri 2019 ([1910.09871](https://arxiv.org/abs/1910.09871)) Table 6. 0.045 AU 의 g + 50 g/cm² shielding + 자기장 기준. 주의: Atri Table 6 은 무차원 enhancement-over-GCR 계수(및 event 당 Gray)이지 연간 mSv/yr dose 가 아니다. 여기 적힌 연간값은 변환이므로 신뢰도 low |
...
Bourgeois 2024 ([2008.09599](https://arxiv.org/abs/2008.09599)) 가 g 에 대해 wmf 0.11–0.24 를 산출했고, 이는
...
([2101.08172](https://arxiv.org/abs/2101.08172)) 는 WMF ≥ 0.14 에서 high-pressure ice phase (HPP) 가
...
[1810.05210](https://arxiv.org/abs/1810.05210)) 이 cloud-free 수소-rich 대기를 배제하지만, secondary 대기는
HST 로 제약되지 않습니다.
...
**Caveat — 대기 retention.** Van Looveren 2024 ([2401.16490](https://arxiv.org/abs/2401.16490)) 에 따르면
g 의 ~120 F_EUV,⊕ (Berardo 2025 / [2506.12140](https://arxiv.org/abs/2506.12140) 이 L_XUV = 1.83×10²⁸ erg/s
...
**Turbet 평형 기준.** Turbet 2018 ([1707.06927](https://arxiv.org/abs/1707.06927)) 은 g 에 대해 CO₂ 대기
...
**GCM 교차 검증.** Fauchez 2019 ([1911.08596](https://arxiv.org/abs/1911.08596)) 는 g 에 대해 ≤10 bar 의
...
**Planet-planet tides.** Hay & Matsuyama 2019 ([1903.04501](https://arxiv.org/abs/1903.04501)) 는 g 가 이심률
...
RM22 ([2203.01065](https://arxiv.org/abs/2203.01065)) 스케일링은 g 를 ~지구의 0.35 배 dipole moment 에
...
- **하늘의 별.** TRAPPIST-1 이 g 의 하늘에서 1.36° 를 차지합니다 (지구에서
  ...
  표면의 비균질성도 중요합니다. Wakeford 2019 ([1811.04877](https://arxiv.org/abs/1811.04877)) 는 TRAPPIST-1
...
- **[2412.10192](https://arxiv.org/abs/2412.10192)** Cherubim 2024 — From CO₂- to H₂O-dominated atmospheres
  in magma ocean phase. g 의 진화된 대기에 대한 조성 프레임워크를
  제공합니다.
- **[1809.07498](https://arxiv.org/abs/1809.07498)** Lincowski 2018 — Evolved climates of TRAPPIST-1 worlds.
...
- **[1810.05210](https://arxiv.org/abs/1810.05210)** Moran 2018 — HST haze limits. 안쪽 5 개 행성 (간접적으로
...
- **[1903.04501](https://arxiv.org/abs/1903.04501)** Hay & Matsuyama 2019 — Tides between TRAPPIST-1 planets.
...
- **[2506.12140](https://arxiv.org/abs/2506.12140)** Berardo 2025 — HST multi-year Ly-α monitoring of
  ...
  항목을 견인합니다.
- **[1912.05749](https://arxiv.org/abs/1912.05749)** Hori & Ogihara 2020 — Hydrogen-rich atmosphere origin.
  g 의 최대 원시 H 대기는 2 wt% 이하이며 수백 Myr 내에 손실됩니다.
  현재 대기가 secondary 임을 뒷받침합니다.
- **[1707.06927](https://arxiv.org/abs/1707.06927)** Turbet 2018 — TRAPPIST-1 행성에 대한 climate diversity
  모델링. g 의 대기 평형 기준 (순수 CO₂ 에 대해 174 K 에서 150 mbar) 을
  견인하며, 그럴듯한 모든 압력에서 snowball 상태임을 확인합니다.
- **[2101.08172](https://arxiv.org/abs/2101.08172)** Acuña 2021 — Hydrosphere 특성화. g 의 빙하 아래 바다
  구조 (ice Ih 위에 high-pressure ice, 그 아래 암석 mantle) 를 검증합니다.
  WMF ≥ 0.14 의 거주 가능성 임계 (HPP 가 암석-물 경계를 봉인) 를 식별합니다.
- **[1911.08596](https://arxiv.org/abs/1911.08596)** Fauchez 2019 — Clouds and hazes 모델링. g 가 10 bar CO₂
  에서조차 snowball 상태임을 확인하고, substellar 부근에만 최소한의 구름이
  형성된다고 밝힙니다.
- **[1811.04877](https://arxiv.org/abs/1811.04877)** Wakeford 2019 — g 의 HST transmission 과 3-온도 항성
...
- **[2203.01065](https://arxiv.org/abs/2203.01065)** RM22 — 조석 고정된 암석 행성의 dynamo 스케일링.
- **[1910.09871](https://arxiv.org/abs/1910.09871)** Atri 2019 — g 의 표면 방사선 dose 표.
...
- **[2210.02484](https://arxiv.org/abs/2210.02484)** HZ catalog. g 를 더 넓은 HZ 후보 중 하나로 등재합니다.
  d 에서 이미 읽었습니다.
- **[2006.11349](https://arxiv.org/abs/2006.11349)** Wunderlich 2020 — Wet/dry e and f. g 는 맥락만. f 에서
  이미 읽었습니다.
- **[2506.16063](https://arxiv.org/abs/2506.16063)** Mass-radius plane classification. 카탈로그 맥락만
  제공합니다.
...
- **[2509.06310](https://arxiv.org/abs/2509.06310)** Deep SETI search with FAST. 시각 정보 아님.
- **[2208.02511](https://arxiv.org/abs/2208.02511)** SETI drift rate context. 시각 정보 아님.
...
- JWST GO 2589 가 flare 특성화 목적으로 g 를 관측했지만 (Burdanov 2025
  / [2512.04265](https://arxiv.org/abs/2512.04265) 기준), 아직 출판된 대기 retrieval 은 없습니다. arXiv 를
...
- [trappist-1-f](trappist-1-f.md) — 내측 형제. snowball/eyeball tipping point 에 위치. g 는 명백한 snowball.
- [trappist-1-h](trappist-1-h.md) — 가장 바깥 형제. 둘 다 얼음 지배이지만 질량/가열 예산이 다름.
- [trappist-1-e](trappist-1-e.md) — 거주가능역 기준점 대조.
- [methodology](../reference/methodology.md) — Decisions 스키마.
- [mod-reference](../reference/mod-reference.md) — 다운스트림 모드.
- [rex-data-comparison](../reference/rex-data-comparison.md) — §10 이 Agol 2021 이후 g 의 질량/반지름을 정량화합니다.
