...
| `water_mass_fraction` | 0.04–0.16 | high | Acuña 2025 ([2504.16201](https://arxiv.org/abs/2504.16201)) 가 MAGRATHEA 로 7-16% 보고, Acuña 2021 ([2101.08172](https://arxiv.org/abs/2101.08172)) 의 Fe/Si 제약 시나리오 2 는 3.7 ± 2.6%. 최근 추정치들의 합집합이 하한을 넓힘 |
...
Acuña 2025 ([2504.16201](https://arxiv.org/abs/2504.16201)) 가 현재 최선의 내부 fit 을 제공합니다. 모든 내부
...
Bourgeois 2024 ([2008.09599](https://arxiv.org/abs/2008.09599)) 의 magma-ocean 진화 작업은 f 가 100 Myr
...
**Sub-glacial ocean 구조.** Acuña 2021 ([2101.08172](https://arxiv.org/abs/2101.08172)) 은 hydrosphere
...
(Driscoll & Olson 의 [2208.06523](https://arxiv.org/abs/2208.06523) 스케일링은 지구 질량 dynamo 가 핵
...
- **[2504.16201](https://arxiv.org/abs/2504.16201)** Acuña 2025 — MAGRATHEA 를 이용한 f 의 내부 구조 분석.
  wmf 16.2% ± 9.9% (free CMF) 또는 6.9% ± 2.0% (지구형 mantle-to-core).
  f 를 ocean world 로 확립하며, sub-glacial ocean cfg 를 견인.
- **[2008.09599](https://arxiv.org/abs/2008.09599)** Bourgeois 2024 — e/f/g 의 magma ocean 진화. f 가 진화를
  거치며 상당량의 물을 보유했다고 예측.
- **[2006.11349](https://arxiv.org/abs/2006.11349)** Wunderlich 2020 — e 와 f 의 wet vs. dry 대기. f 의 대기를
  CO₂-rich (snowball branch) 또는 dry desiccated post-runaway 상태로 제약.
- **[1809.07498](https://arxiv.org/abs/1809.07498)** Lincowski 2018 — TRAPPIST-1 세계들의 진화한 기후. f 는
  Lincowski 의 모델링이 차갑고 CO₂-rich 한 대기를 평형으로 보여주는 행성
  중 하나. d Phase 3 / e Phase 3 에서 이미 읽음.
- **[1712.05641](https://arxiv.org/abs/1712.05641)** Barr 2018 — TRAPPIST-1 행성들의 내부 구조와 조석 가열.
  f 의 조석 heat flux 를 0.14 W/m² (이전 추정 대비 30배) 로 상향 수정하는
  근거. Maxwell viscoelastic. mantle T_eq 1621 K.
- **[2101.08172](https://arxiv.org/abs/2101.08172)** Acuña 2021 — Hydrosphere 특성화. f 의 sub-glacial ocean
  구조 (ice Ih / high-pressure ice / ice VII) 를 상세히 다룸. WMF
  3.7 ± 2.6% scenario 2 로 water 함량의 하한을 넓힘.
- **[1707.06927](https://arxiv.org/abs/1707.06927)** Turbet 2018 — TRAPPIST-1 의 기후 다양성 모델링.
  **snowball 기본값을 견인.** 0.1 bar CO₂ 에서 f 는 완전히 얼음으로 덮임
  (substellar lens 없음). open ocean 은 ≥1 bar CO₂ 에서만 나타남. 극지
  CO₂ cold-trap 기하도 식별.
- **[1710.08761](https://arxiv.org/abs/1710.08761)** Kislyakova 2017 — Induction heating 추정. f 의 총량
  ~1.1×10¹⁸ W. cfg 의 induction heating 을 하향 수정.
- **[1911.08596](https://arxiv.org/abs/1911.08596)** Fauchez 2019 — HZ TRAPPIST-1 행성들의 구름 및 haze
  모델링. CO₂ 압력 ≤10 bar 의 모든 그럴듯한 범위에서 f 의 snowball
  상태를 확인.
- **[1706.04617](https://arxiv.org/abs/1706.04617)** Garraffo 2017 — TRAPPIST-1 의 위협적인 자기 및 플라즈마
  환경. f 를 거주 가능 영역의 대표 케이스로 채택. 0.3 G 테스트 케이스가
  cfg dipole moment 를 견인.
- **[2203.01065](https://arxiv.org/abs/2203.01065)** RM22 — 암석 행성 magnetic moment 스케일링.
- **[1910.09871](https://arxiv.org/abs/1910.09871)** Atri 2019 — f 의 표면 선량 테이블.

### 읽음 (맥락 / 방법론, 결정 견인 안 함)

- **[2605.06964](https://arxiv.org/abs/2605.06964)** TRAPPIST-1 기후의 에너지 균형 모델. 방법론 논문이며 f 의
  snowball 상태를 지지.
- **[2506.21351](https://arxiv.org/abs/2506.21351)** SEPHI 2.0 거주 가능성 지수. 카탈로그 맥락만.
- **[2502.00132](https://arxiv.org/abs/2502.00132)** Way 2025 — d 중심 논문이지만 f 에도 적용되는 tidally-locked
  GCM 의 유용한 방법론 reference.
- **[1810.05210](https://arxiv.org/abs/1810.05210)** Moran 2018 — HST haze 한계. d Phase 3 에서 이미 읽음.
