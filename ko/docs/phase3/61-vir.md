...
이내에서 일치), 현대 isochrone 나이는 7.70 +0.28/-0.26 Gyr 입니다
(Rathsam 2023). 이는 Mamajek & Hillenbrand 2008 의 색채권 활동도-나이
~6 Gyr 보다 오래되었지만, Vogt 2010 / von Braun 2014 / Sanz-Forcada
2010 의 isochrone consensus (~8–9 Gyr) 와 일치합니다. 별 자체는 조용한
...
교차 확인으로 강등되었습니다. 나이 행은 이제 isochrone (Rathsam 2023)
주도이며, 오래된 활동도-나이 (Mamajek 2008) 는 교차 확인으로 강등됩니다.
문헌은 방법에 따라 ~6 Gyr 와 ~8 Gyr 사이로 갈리며, Phase 3 는
isochrone consensus 를 Confidence=medium 으로 채택해 미해결 분할을
플래그합니다. tie-break 세 행은 시각 색조, debris 띠 산란 색조, debris
...
| `age_gyr` | 7.70 +0.28/-0.26 | medium | Rathsam et al. 2023 의 Yale-Potsdam isochrone (가장 최신 + 가장 작은 형식 불확실도). Vogt 2010 (8.96 +2.76/-3.08) 과 von Braun 2014 (8.6) 모두 isochrone 으로 ~8–9 Gyr. Sanz-Forcada 2010 X-ray 나이 7.96 Gyr 가 동의. **Documented divergence.** Mamajek & Hillenbrand 2008 의 색채권 활동도-나이는 6.1 ± 1.7 Gyr — isochrone (오래됨) 과 활동도-나이 (젊음) 코호트 사이의 방법론적 불일치. Phase 3 는 isochrone consensus 를 선택하되 미해결 분할을 플래그하기 위해 Confidence=medium 유지 |
...
- **Rathsam A., Meléndez J. & Carvalho Silva G. 2023** — *Lithium
  ...
  질량 (0.93 ± 0.01 M☉), [Fe/H] (+0.006 ± 0.004), 나이 (7.70 +0.28/
  -0.26 Gyr), log g (4.390 ± 0.012) 를 공급. **61 Vir 의 주된 Phase 2
...
- **Mamajek E. E. & Hillenbrand L. A. 2008** — *Improved Age Estimation
  ...
  isochrone 결합으로 6.1 ± 1.7 Gyr — 문헌 분포의 **젊은 쪽**. Rathsam
  2023 / von Braun 2014 / Vogt 2010 의 isochrone consensus (~7.7–9 Gyr)
  와 **documented divergence**. Phase 3 는 isochrone 값을 채택하되 미해결
  분할을 반영하기 위해 Confidence=medium 플래그합니다.
...
- **Sanz-Forcada J. et al. 2010** — *X-ray ages for nearby stars*,
  ...
  Gyr. isochrone consensus (~8 Gyr) 와 일관되며 더 젊은 Mamajek 2008
  활동도-나이와는 불일치.
...
- **Asteroseismic 캠페인.** Vmag 4.71 의 61 Vir 는 HARPS/ESPRESSO 로
  ...
  좁혀지고, isochrone-대-활동도 나이 분기 (Rathsam 2023 의 7.70
  +0.28/-0.26 Gyr 대 Mamajek 2008 의 6.1 ± 1.7 Gyr — 두 파이프라인이
  반대 방향으로 ~1.5σ 차이) 를 중재할 수 있습니다. Δν + ν_max 에 묶인
  나이는 불확실도를 약 3 배 줄이며, Yu 2024 의 P_rot = 32.1 일이 이미
  ~8 Gyr Skumanich 기대치와 일치하는 점을 고려하면 isochrone 해석을
  확인할 가능성이 높습니다.
