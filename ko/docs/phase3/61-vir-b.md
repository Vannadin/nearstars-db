...
|---|---|---|---|
| `tidally_locked` | true | high | 0.050 AU 의 4.215 일 궤도. 조석 고정 시간 ~10⁵–10⁶ 년 (5 M⊕, G 왜성 호스트에 대한 Vinson 2017 스케일링) 이 6 Gyr 시스템 나이보다 한참 짧음 |
...
| `insolation_s_earth` | 326 | high | L = 0.822 L☉ (von Braun 2014) 와 a = 0.0502 AU 에서 유도 |
...
**색 선택.** 솔라 트윈 조명 (Teff 5568 K, 거의 태양 SED) 아래에서
...
~10⁵–10⁶ 년 (G 왜성 호스트에서 5 M⊕ 암석 행성에 대한 Vinson 2017
스케일링) 을 주는데, 6 Gyr 시스템 나이보다 4–5 자릿수 더 짧습니다.
1:1 spin-orbit 공명이 완전히 자리잡혀 있습니다. 황도경사각은 같은
시간 스케일에 걸쳐 0 까지 감쇠했습니다.

**고차 공명.** 이심률 0.12 (Vogt 2010 fit) 에서 Makarov 2012 / Vinson
2017 안정성 분석은 1:1 의 대안으로 3:2 공명 trap 을 허용합니다.
...
- **대기 haze.** 가시광에서 없음. 규산염-증기 외기권은 ~10⁻⁷ Pa 로
  ...
  가장자리.
- **하늘의 별.** 61 Vir 가 b 에서 1.04° 차지 — 지구에서 본 태양 각
  크기의 약 2 배. 색은 본질적으로 태양빛 노란 (Teff 5568 K → `#fff2dc`
...
- **Vinson A. M. & Hansen B. M. S. 2017** — *On the spin states of
  ...
  암석 행성의 조석 고정 시간 스케일. b 의 파라미터에서 ~10⁵–10⁶ 년.
...
- **Bolmont E. et al. 2020** — *Tidal dissipation and obliquity
  ...
  2002.02015). 암석 외계행성의 조석 가열 스케일링. e=0.12, P=4.2 d
  에서 0.1–1 W/m² 추정값 제공.
...
- **von Braun K. et al. 2014** — *Stellar diameters V*, MNRAS 438,
  ...
  합성에서 상속. CHARA 간섭 R = 0.9867 ± 0.0048 R☉ 와 L = 0.8222 ±
  0.0033 L☉ — 일사와 겉보기 각지름 유도의 앵커.
- **Mamajek E. E. & Hillenbrand L. A. 2008** — *Improved Age
  ...
  호스트 합성에서 상속. 활동도-나이 6.1 ± 1.7 Gyr. Rathsam 2023
  isochrone 에 대한 교차 확인으로 강등 (호스트 합성에서 documented
  divergence).
- **Wyatt M. C. et al. 2012** — *Herschel imaging of 61 Vir*, MNRAS
  424, 1206 (`2012MNRAS.424.1206W`, arXiv:1206.2370). 호스트 합성에서
...
- **Howe A. R. et al. 2014** — *Mass-radius relations and core-envelope
  ...
  (`2014ApJ...787..173H`, arXiv:1311.0329). envelope-vs-rocky 결정의
  맥락에서 간략히 사용. b 는 암석.
