...
Per-element flame test / low-temperature plasma colors. Replaces pixel-sampling of the Helmenstine 2017 chart (whose decorative gradient blurs the intended hex). Source: chemistry literature + the [NIST Atomic Spectra Database](https://physics.nist.gov/asd), with the [Helmenstine chart](https://sciencenotes.org/flame-test-colors-and-procedure-chemistry/) as visual sanity check.
...
| 102 | **No** | Nobelium | — | half-life too short | — | Longest-lived isotope t½ ≈ 58 minutes |
| 103 | **Lr** | Lawrencium | — | half-life too short | — | Longest-lived isotope t½ ≈ 11 hours |

## Sources

- [NIST Atomic Spectra Database](https://physics.nist.gov/asd) — line wavelengths and relative intensities behind every `cie_computed` hex
- [Helmenstine flame-test chart (sciencenotes.org)](https://sciencenotes.org/flame-test-colors-and-procedure-chemistry/) — the visual sanity check (the 2017 edition was the one consulted)
- [db/refs/element_plasma_colors.yaml](../../db/refs/element_plasma_colors.yaml) — the canonical dataset; each element/regime carries its own `source:` citation string (NIST line lists, arXiv 2007.04869 for Mars EDL, aurora/reentry spectroscopy literature)
