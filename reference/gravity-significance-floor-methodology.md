...
[`2021AJ....161..105P`](https://ui.adsabs.harvard.edu/abs/2021AJ....161..105P)). DE uses **no main-belt ring**: the remaining ~10% of belt mass is
...
INPOP. Kuchynka et al. 2010 ([`2010A&A...514A..96K`](https://ui.adsabs.harvard.edu/abs/2010A%26A...514A..96K)) fix a main-belt ring at 2.8 AU of mass
...
1970–2010 (Fienga et al. 2011, [`2011CeMDA.111..363F`](https://ui.adsabs.harvard.edu/abs/2011CeMDA.111..363F)). So the *operative* threshold is a
...
down to an order of a meter"* ([`2011CeMDA.111..363F`](https://ui.adsabs.harvard.edu/abs/2011CeMDA.111..363F)), with the sub-threshold remainder
aggregated via the Kuchynka ring; by INPOP19a the individual set grew to 343 plus a Kuiper ring
of `(0.061 ± 0.001) M⊕` (Di Ruscio et al. 2020, [`2020A&A...640A...7D`](https://ui.adsabs.harvard.edu/abs/2020A%26A...640A...7D)). EPM likewise splits
...
Pitjev 2018, [`2018AstL...44..554P`](https://ui.adsabs.harvard.edu/abs/2018AstL...44..554P)).
...
> **Numbers extracted**
> - **343**: asteroids integrated individually in DE430/431 & DE440/441 (≈90% of belt mass) ([`2014IPNPR.196C...1F`](https://ui.adsabs.harvard.edu/abs/2014IPNPR.196C...1F); [`2021AJ....161..105P`](https://ui.adsabs.harvard.edu/abs/2021AJ....161..105P))
> - selection = "most significant effects on the orbit of Mars…"; remaining ~10% **dropped**, no main-belt ring in DE ([`2014IPNPR.196C...1F`](https://ui.adsabs.harvard.edu/abs/2014IPNPR.196C...1F))
> - **4–38 m**: residual Earth–Mars range effect after one ring absorbs the sub-threshold tail (N=300); ">99% of global perturbation" captured ([`2010A&A...514A..96K`](https://ui.adsabs.harvard.edu/abs/2010A%26A...514A..96K))
> - ~1199 m: largest single-asteroid (Ceres) effect on Earth–Mars distance, 1970–2010 ([`2011CeMDA.111..363F`](https://ui.adsabs.harvard.edu/abs/2011CeMDA.111..363F))
> - ~240 asteroids "down to an order of a meter": INPOP metre-level individual-perturber threshold ([`2011CeMDA.111..363F`](https://ui.adsabs.harvard.edu/abs/2011CeMDA.111..363F))
> - 301 individual + ring at 2.67 AU `(0.507±0.051)×10⁻¹⁰ M☉`; total belt `(12.038±0.087)×10⁻¹⁰ M☉`, EPM ([`2018AstL...44..554P`](https://ui.adsabs.harvard.edu/abs/2018AstL...44..554P))
...
spanning 1999–2013 plus radar delay at three apparitions ([`2014Icar..235....5C`](https://ui.adsabs.harvard.edu/abs/2014Icar..235....5C)). The
...
the literature, at signal-to-noise ~200 (Farnocchia et al. 2013, [`2013Icar..224....1F`](https://ui.adsabs.harvard.edu/abs/2013Icar..224....1F): *"The
...
unambiguously reveals a small nongravitational acceleration"* ([`2003Sci...302.1739C`](https://ui.adsabs.harvard.edu/abs/2003Sci...302.1739C)), again
...
orbital drift with a signal to noise ratio (SNR) greater than 3"* ([`2013Icar..224....1F`](https://ui.adsabs.harvard.edu/abs/2013Icar..224....1F)), and
Nugent et al. report *"observed drifts (~10⁻³ AU Myr⁻¹)"* across 54 NEAs, order ~10⁻¹³ m/s²
transverse ([`2012AJ....144...60N`](https://ui.adsabs.harvard.edu/abs/2012AJ....144...60N)). So the natural-body detectability floor spans roughly
...
(Anderson et al. 2002, [`2002PhRvD..65h2004A`](https://ui.adsabs.harvard.edu/abs/2002PhRvD..65h2004A)), and even that proved an artifact: *"once the
thermal recoil force is properly accounted for, no anomalous acceleration remains"* (Turyshev
et al. 2012, [`2012PhRvL.108x1101T`](https://ui.adsabs.harvard.edu/abs/2012PhRvL.108x1101T)). That a 8.7×10⁻¹⁰ m/s² signal turned out to be spacecraft
...
> **Numbers extracted**
> - **9.3×10⁻¹³ m/s²**: Bennu transverse Yarkovsky accel (A2 = −4.618×10⁻¹⁴ au/day²), best natural-body detection, SNR~200 ([`2014Icar..235....5C`](https://ui.adsabs.harvard.edu/abs/2014Icar..235....5C))
> - 284 ± 1.5 m/yr: Bennu semimajor-axis drift, 1999–2013 optical + 3-apparition radar ([`2014Icar..235....5C`](https://ui.adsabs.harvard.edu/abs/2014Icar..235....5C))
> - ~75–300 m: radar delay precision per apparition enabling the Bennu detection ([`2014Icar..235....5C`](https://ui.adsabs.harvard.edu/abs/2014Icar..235....5C))
> - ~10⁻³ AU/Myr (~10⁻¹³ m/s²): typical measured Yarkovsky drift across 54 NEAs ([`2012AJ....144...60N`](https://ui.adsabs.harvard.edu/abs/2012AJ....144...60N))
> - SNR > 3 for only 21 NEAs: statistical detection threshold for Yarkovsky in orbital fits ([`2013Icar..224....1F`](https://ui.adsabs.harvard.edu/abs/2013Icar..224....1F))
> - first direct Yarkovsky detection, Arecibo radar, 0.5-km Golevka ([`2003Sci...302.1739C`](https://ui.adsabs.harvard.edu/abs/2003Sci...302.1739C))
> - **8.74×10⁻¹⁰ m/s²**: Pioneer anomaly, Doppler+ranging over ~11.5 yr; later resolved as thermal recoil ([`2002PhRvD..65h2004A`](https://ui.adsabs.harvard.edu/abs/2002PhRvD..65h2004A); [`2012PhRvL.108x1101T`](https://ui.adsabs.harvard.edu/abs/2012PhRvL.108x1101T))
...
(2010, [`2010MNRAS.401..977J`](https://ui.adsabs.harvard.edu/abs/2010MNRAS.401..977J)) define `r_J ≡ [G(M₁+M₂)/(4 Ω_g A_g)]^(1/3)` and evaluate it for
...
out to ~1 pc (Chanamé & Gould 2004, [`2004ApJ...601..289C`](https://ui.adsabs.harvard.edu/abs/2004ApJ...601..289C)); El-Badry's Gaia review
([`2024NewAR..9801694E`](https://ui.adsabs.harvard.edu/abs/2024NewAR..9801694E), [arXiv:2403.12146](https://arxiv.org/abs/2403.12146)) reports the same slope and notes bound pairs are
...
over Gyr (Weinberg, Shapiro & Wasserman 1987, [`1987ApJ...312..367W`](https://ui.adsabs.harvard.edu/abs/1987ApJ...312..367W)), so the observed widest
...
> **Numbers extracted**
> - **1.7 pc = 5.5 ly**: Jacobi (tidal) radius for a 2 M☉ (1+1) pair in the solar neighborhood ([`2010MNRAS.401..977J`](https://ui.adsabs.harvard.edu/abs/2010MNRAS.401..977J))
> - `r_J = [G(M₁+M₂)/(4 Ω_g A_g)]^(1/3)`, `Ω_g ≈ 27`, `A_g ≈ 15 km/s/kpc`: formula + Oort inputs ([`2010MNRAS.401..977J`](https://ui.adsabs.harvard.edu/abs/2010MNRAS.401..977J))
> - **~1×10⁻¹³ m/s²**: mutual = tidal acceleration at the crossover (physically motivated floor) (derived from [`2010MNRAS.401..977J`](https://ui.adsabs.harvard.edu/abs/2010MNRAS.401..977J))
> - α = 1.67 ± 0.07 (disk), single power law to ~1 pc: observed wide-binary separation distribution ([`2004ApJ...601..289C`](https://ui.adsabs.harvard.edu/abs/2004ApJ...601..289C))
> - bound to ~5×10⁴ AU (~0.24 pc); ≳10⁵ AU mostly chance alignments: observed max bound separation ([`2024NewAR..9801694E`](https://ui.adsabs.harvard.edu/abs/2024NewAR..9801694E))
> - `r_c(1 M☉) = 0.37 pc` vs `r_J = 1.7 pc`: `r_c` is ~4.6× *inside* the tidal crossover (two-body term still dominant there) (comparison vs [`2010MNRAS.401..977J`](https://ui.adsabs.harvard.edu/abs/2010MNRAS.401..977J))
...
(Rein & Spiegel 2015, [`2015MNRAS.446.1424R`](https://ui.adsabs.harvard.edu/abs/2015MNRAS.446.1424R)). WHFast is engineered so *"E_bias is absent… its
...
[`2015MNRAS.452..376R`](https://ui.adsabs.harvard.edu/abs/2015MNRAS.452..376R); foundational method: Wisdom & Holman 1991, [`1991AJ....102.1528W`](https://ui.adsabs.harvard.edu/abs/1991AJ....102.1528W)). So the
...
([`2002JCoPh.179...27D`](https://ui.adsabs.harvard.edu/abs/2002JCoPh.179...27D)) states *"in collisionless stellar dynamics a relative force error of few
10⁻³ is often sufficient,"* achieved at opening angle `θ ≃ 0.5–0.65`; Barnes & Hut 1986
([`1986Natur.324..446B`](https://ui.adsabs.harvard.edu/abs/1986Natur.324..446B)) and its error analyses established that galaxy/cluster codes routinely
...
> - 10⁻⁹: WHFast/IAS15 default user accuracy parameter `ε_b` ([`2015MNRAS.446.1424R`](https://ui.adsabs.harvard.edu/abs/2015MNRAS.446.1424R))
> - 10⁻¹⁶: IAS15 internal convergence tolerance ≈ double-precision machine ε (roundoff floor) ([`2015MNRAS.446.1424R`](https://ui.adsabs.harvard.edu/abs/2015MNRAS.446.1424R))
> - 2–3 orders: WHFast relative-energy improvement over classic WH map; unbiased, Brouwer scaling ([`2015MNRAS.452..376R`](https://ui.adsabs.harvard.edu/abs/2015MNRAS.452..376R))
> - few×10⁻³: accepted relative *force* error for collisionless tree codes at `θ ≃ 0.5–0.65` ([`2002JCoPh.179...27D`](https://ui.adsabs.harvard.edu/abs/2002JCoPh.179...27D); [`1986Natur.324..446B`](https://ui.adsabs.harvard.edu/abs/1986Natur.324..446B))
...
rides on: DE440 carries **343 asteroids + 30 KBOs + a KBO ring** ([`2021AJ....161..105P`](https://ui.adsabs.harvard.edu/abs/2021AJ....161..105P)), ~20×
...
> - **343 + 30 KBOs + ring**: perturbers in the underlying DE440 ephemeris (~20× the nav model) ([`2021AJ....161..105P`](https://ui.adsabs.harvard.edu/abs/2021AJ....161..105P))
